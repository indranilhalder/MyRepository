...
/**
 * Provides necessary meta information about the luxurycheckoutaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.5.1.0
 */
public class LuxurycheckoutaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(LuxurycheckoutaddonHMCExtension.class.getName());
