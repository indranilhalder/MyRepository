...
import com.tisl.lux.constants.LuxurycheckoutaddonConstants;



/**
 * This is the extension manager of the Luxurycheckoutaddon extension.
 */
public class LuxurycheckoutaddonManager extends GeneratedLuxurycheckoutaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(LuxurycheckoutaddonManager.class.getName());
	 ...
	 */
	public static LuxurycheckoutaddonManager getInstance()
	{
		return (LuxurycheckoutaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				LuxurycheckoutaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public LuxurycheckoutaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of LuxurycheckoutaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of LuxurycheckoutaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of LuxurycheckoutaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
