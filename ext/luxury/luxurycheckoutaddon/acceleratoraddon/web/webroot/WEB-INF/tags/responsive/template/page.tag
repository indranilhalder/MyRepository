...
<%@ taglib prefix="header"
	tagdir="/WEB-INF/tags/addons/luxurycheckoutaddon/responsive/common/header"%>
<%@ taglib prefix="footer"
	tagdir="/WEB-INF/tags/addons/luxurystoreaddon/responsive/common/footer"%>
	...
	<jsp:body>
		...
		<main data-currency-iso-code="${currentCurrency.isocode}">	
		 <%-- <spring:theme code="text.skipToContent" var="skipToContent" />
			...
			<header:luxuryHeader hideHeaderLinks="${hideHeaderLinks}" />
