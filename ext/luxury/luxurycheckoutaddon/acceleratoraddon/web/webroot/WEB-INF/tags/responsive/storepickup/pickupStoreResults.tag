...
<%@ taglib prefix="store" tagdir="/WEB-INF/tags/addons/luxurycheckoutaddon/responsive/store" %>
<%@ taglib prefix="ycommerce" uri="http://hybris.com/tld/ycommercetags" %>
<%@ taglib prefix="storepickup" tagdir="/WEB-INF/tags/addons/luxurycheckoutaddon/responsive/storepickup" %>
