...
/**
 * Provides necessary meta information about the luxurystoreaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.5.1.0
 */
public class LuxurystoreaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(LuxurystoreaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.tisl.lux.hmc.locales";
