...
/**
 * This is the extension manager of the Luxurystoreaddon extension.
 */
public class LuxurystoreaddonManager extends GeneratedLuxurystoreaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(LuxurystoreaddonManager.class.getName());
	 ...
	 */
	public static LuxurystoreaddonManager getInstance()
	{
		return (LuxurystoreaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				LuxurystoreaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public LuxurystoreaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of LuxurystoreaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of LuxurystoreaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of LuxurystoreaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
