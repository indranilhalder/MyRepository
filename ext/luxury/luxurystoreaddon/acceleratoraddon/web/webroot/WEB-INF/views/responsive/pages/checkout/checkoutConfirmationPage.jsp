...
<input type="hidden" id="order_shipping_modes" value='${order_shipping_modes}'>
    ...
    <div class="btn-design mb-40 mt-40">
     <div class="left  mb-10"><a href="/my-account/orders"><button class="btn btn-default btn-lg">Track Order</button></a></div>
     <div class="right mb-10"><a href="/"><button class="btn btn-primary btn-lg">Continue Shopping</button></a></div>    
