...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
								...
								<!-- TISSIT-1703 -->
								<form:form action="/j_spring_security_check" method="post" name='flyOutloginForm'>
...
<!-- For  Gigya and API Social Login -->					
  ...
  <script type="text/javascript">
    	...
    	gigya.socialize.showLoginUI({
            ...
            ,enabledProviders : 'facebook,google'
								...
								<ul class="signin-flyout social-connect" id="gSignInWrapper">
									<li><a href="#nogo" class="fb" id="fbLoginButton">hello
	...
	<!-- End  Gigya and API Social Login -->
								...
								<li><div class="foot">
									<spring:theme code="luxury.header.flyout.signup.member"/><ycommerce:testId
													code="luxury_header_Register_link">
													 <a class="register_link" href="<c:url value="/login?isSignInActive=N"/>"> 
													<spring:theme
															code="luxury.header.link.register" />
													</a>
												</ycommerce:testId>
													</div>
											</li>
...
<script type="text/javascript">
	...
	$("#triggerLoginAjax").click(function(){
		...
		$("#errorHolder").text("Please enter all mandatory fields1");
		return false;
