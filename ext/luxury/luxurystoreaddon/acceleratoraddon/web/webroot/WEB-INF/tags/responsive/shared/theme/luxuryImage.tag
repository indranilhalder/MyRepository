...
<img class="${imgClass}" src="${imageUrl}" alt="${alt}" title="${title}" onError="this.onerror=null;this.src='/_ui/responsive/theme-luxury/images/plpPlaceholder.png';this.className='${imgClass} error';"/>
