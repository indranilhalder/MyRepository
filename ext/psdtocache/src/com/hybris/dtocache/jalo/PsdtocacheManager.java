 ...
 *  
 */
package com.hybris.dtocache.jalo;

import java.util.Map;

import org.apache.log4j.Logger;

import com.hybris.dtocache.constants.PsdtocacheConstants;

import de.hybris.platform.core.Registry;
import de.hybris.platform.util.JspContext;

/**
 * This is the extension manager of the Psdtocache extension.
 */
public class PsdtocacheManager extends GeneratedPsdtocacheManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(PsdtocacheManager.class.getName());
	 ...
	 */
	public static PsdtocacheManager getInstance()
	{
		return (PsdtocacheManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(PsdtocacheConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PsdtocacheManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of PsdtocacheManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of PsdtocacheManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of PsdtocacheManager called, current tenant: " + getTenant().getTenantID());
		}
	}
