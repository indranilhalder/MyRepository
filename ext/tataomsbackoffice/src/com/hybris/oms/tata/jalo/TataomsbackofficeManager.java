 ...
 */
package com.hybris.oms.tata.jalo;
 ...
 */
public class TataomsbackofficeManager extends GeneratedTataomsbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TataomsbackofficeManager.class.getName());
	 ...
	 */
	public static TataomsbackofficeManager getInstance()
	{
		return (TataomsbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TataomsbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TataomsbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TataomsbackofficeManager called.");
		}
	}
