 ...
 *
 */
public class TshipPriorityMasterValidator
{
	/**
	...
	public boolean validate(final PriorityMaster priorityMaster, final FileWriter writer, final int rowNumber) throws IOException
	{
		...
		validatePrioritiesAir(priorityMaster.getAirPriorityMaster().getAirPrepaidPriority1(),
				...
				priorityMaster.getAirPriorityMaster().getAirPrepaidPriority5(), TshipExcelConstants.PREPAID_PRIORITY1_ISEMPTY_AIR,
				writer, rowNumber);
		...
		validatePrioritiesAir(priorityMaster.getAirPriorityMaster().getAirCodPriority1(),
				...
				priorityMaster.getAirPriorityMaster().getAirCodPriority5(), TshipExcelConstants.COD_PRIORITY1_ISEMPTY_AIR, writer,
				rowNumber);
		...
		validatePrioritiesSur(priorityMaster.getSurfacePriorityMaster().getSurfacePrepaidPriority1(),
				...
				TshipExcelConstants.PREPAID_PRIORITY1_ISEMPTY_SURFACE, writer, rowNumber);
		...
		validatePrioritiesSur(priorityMaster.getSurfacePriorityMaster().getSurfaceCodPriority1(),
				...
				priorityMaster.getSurfacePriorityMaster().getSurfaceCodPriority4(), TshipExcelConstants.COD_PRIORITY1_ISEMPTY_SURFACE,
				writer, rowNumber);
		...
		checkPrioritiesforEqualityAir(priorityMaster.getAirPriorityMaster().getAirPrepaidPriority1(),
				...
				priorityMaster.getAirPriorityMaster().getAirPrepaidPriority3(),
				priorityMaster.getAirPriorityMaster().getAirPrepaidPriority4(),
				priorityMaster.getAirPriorityMaster().getAirPrepaidPriority5(), TshipExcelConstants.PREPAID_PRIORITY1AND2_SAME_AIR,
				writer, rowNumber);
		checkPrioritiesforEqualityAir(priorityMaster.getAirPriorityMaster().getAirCodPriority1(),
				priorityMaster.getAirPriorityMaster().getAirCodPriority2(),
				priorityMaster.getAirPriorityMaster().getAirCodPriority3(),
				priorityMaster.getAirPriorityMaster().getAirCodPriority4(),
				priorityMaster.getAirPriorityMaster().getAirCodPriority5(), TshipExcelConstants.COD_PRIORITY1AND2_SAME_AIR, writer,
				rowNumber);
		checkPrioritiesforEqualitySur(priorityMaster.getSurfacePriorityMaster().getSurfacePrepaidPriority1(),
				priorityMaster.getSurfacePriorityMaster().getSurfacePrepaidPriority2(),
				priorityMaster.getSurfacePriorityMaster().getSurfacePrepaidPriority3(),
				priorityMaster.getSurfacePriorityMaster().getSurfacePrepaidPriority4(),
				TshipExcelConstants.PREPAID_PRIORITY1AND2_SAME_SURFACE, writer, rowNumber);
		checkPrioritiesforEqualitySur(priorityMaster.getSurfacePriorityMaster().getSurfaceCodPriority1(),
				priorityMaster.getSurfacePriorityMaster().getSurfaceCodPriority2(),
				priorityMaster.getSurfacePriorityMaster().getSurfaceCodPriority3(),
				priorityMaster.getSurfacePriorityMaster().getSurfaceCodPriority4(),
				TshipExcelConstants.COD_PRIORITY1AND2_SAME_SURFACE, writer, rowNumber);
				...
				&& priorityMaster.getSurfacePriorityMaster().getSurfacePrepaidPriority1().length() == 1)
		{
			writer.write(
					(TshipExcelConstants.ROW_VALUE + TshipExcelConstants.EMPTY_SPACE + rowNumber + TshipExcelConstants.EMPTY_SPACE
							+ TshipExcelConstants.PREPAID_PRIORITY1_AIR_OR_SURFACE_ISEMPTY + TshipExcelConstants.NEW_LINE));
		}
				...
				&& logisticPartner5 != null)
		{
					...
					|| logisticPartner4.length() > 1 || logisticPartner5.length() > 1))
			{
				writer.write(TshipExcelConstants.ROW_VALUE + TshipExcelConstants.EMPTY_SPACE + rowNumber
						+ TshipExcelConstants.EMPTY_SPACE + validationMessage + TshipExcelConstants.NEW_LINE);
			}
		}
	}
			...
			final String validationMessage, final FileWriter writer, final int rowNumber) throws IOException
	{
				...
				&& logisticPartner5 != null)
		{
			 ...
			 * writer.write(TshipExcelConstants.ROW_VALUE+TshipExcelConstants.EMPTY_SPACE+rowNumber+TshipExcelConstants.
			 * EMPTY_SPACE+ validationMessage+TshipExcelConstants.NEW_LINE); }
			 */
		}
	}
	...
	private void validateAirPrepaidPriorities(final PriorityMaster priorityMaster, final FileWriter writer, final int rowNumber)
			throws IOException
	{
		if (priorityMaster.getAirPriorityMaster().getAirPrepaidPriority1().length() > 1 && !TshipLogisticPartnerUtil
				.containsLogisticPartnerName(priorityMaster.getAirPriorityMaster().getAirPrepaidPriority1()))
		{
			writer.write(
					TshipExcelConstants.ROW_VALUE + TshipExcelConstants.EMPTY_SPACE + rowNumber + TshipExcelConstants.EMPTY_SPACE
							+ TshipExcelConstants.PREPAID_PRIORITY1_NAME_VALIDATION_AIR + TshipExcelConstants.NEW_LINE);
		}
		else if (priorityMaster.getAirPriorityMaster().getAirPrepaidPriority2().length() > 1 && !TshipLogisticPartnerUtil
				.containsLogisticPartnerName(priorityMaster.getAirPriorityMaster().getAirPrepaidPriority2()))
		{
			writer.write(
					TshipExcelConstants.ROW_VALUE + TshipExcelConstants.EMPTY_SPACE + rowNumber + TshipExcelConstants.EMPTY_SPACE
							+ TshipExcelConstants.PREPAID_PRIORITY2_NAME_VALIDATION_AIR + TshipExcelConstants.NEW_LINE);
		}
		else if (priorityMaster.getAirPriorityMaster().getAirPrepaidPriority3().length() > 1 && !TshipLogisticPartnerUtil
				.containsLogisticPartnerName(priorityMaster.getAirPriorityMaster().getAirPrepaidPriority3()))
		{
			writer.write(
					TshipExcelConstants.ROW_VALUE + TshipExcelConstants.EMPTY_SPACE + rowNumber + TshipExcelConstants.EMPTY_SPACE
							+ TshipExcelConstants.COD_PRIORITY3_NAME_VALIDATION_AIR + TshipExcelConstants.NEW_LINE);
		}
		else if (priorityMaster.getAirPriorityMaster().getAirPrepaidPriority4().length() > 1 && !TshipLogisticPartnerUtil
				.containsLogisticPartnerName(priorityMaster.getAirPriorityMaster().getAirPrepaidPriority4()))
		{
			writer.write(
					TshipExcelConstants.ROW_VALUE + TshipExcelConstants.EMPTY_SPACE + rowNumber + TshipExcelConstants.EMPTY_SPACE
							+ TshipExcelConstants.COD_PRIORITY4_NAME_VALIDATION_AIR + TshipExcelConstants.NEW_LINE);
		}
		else if (priorityMaster.getAirPriorityMaster().getAirPrepaidPriority5().length() > 1 && !TshipLogisticPartnerUtil
				.containsLogisticPartnerName(priorityMaster.getAirPriorityMaster().getAirPrepaidPriority5()))
		{
			writer.write(
					TshipExcelConstants.ROW_VALUE + TshipExcelConstants.EMPTY_SPACE + rowNumber + TshipExcelConstants.EMPTY_SPACE
							+ TshipExcelConstants.COD_PRIORITY5_NAME_VALIDATION_AIR + TshipExcelConstants.NEW_LINE);
		}
	}
			...
			throws IOException
	{
		if (priorityMaster.getAirPriorityMaster().getAirCodPriority1().length() > 1
				&& !TshipLogisticPartnerUtil.containsLogisticPartnerName(priorityMaster.getAirPriorityMaster().getAirCodPriority1()))
		{
			writer.write(
					TshipExcelConstants.ROW_VALUE + TshipExcelConstants.EMPTY_SPACE + rowNumber + TshipExcelConstants.EMPTY_SPACE
							+ TshipExcelConstants.COD_PRIORITY1_NAME_VALIDATION_AIR + TshipExcelConstants.NEW_LINE);
		}
		else if (priorityMaster.getAirPriorityMaster().getAirCodPriority2().length() > 1
				&& !TshipLogisticPartnerUtil.containsLogisticPartnerName(priorityMaster.getAirPriorityMaster().getAirCodPriority2()))
		{
			writer.write(
					TshipExcelConstants.ROW_VALUE + TshipExcelConstants.EMPTY_SPACE + rowNumber + TshipExcelConstants.EMPTY_SPACE
							+ TshipExcelConstants.COD_PRIORITY2_NAME_VALIDATION_AIR + TshipExcelConstants.NEW_LINE);
		}
		else if (priorityMaster.getAirPriorityMaster().getAirCodPriority3().length() > 1
				&& !TshipLogisticPartnerUtil.containsLogisticPartnerName(priorityMaster.getAirPriorityMaster().getAirCodPriority3()))
		{
			writer.write(
					TshipExcelConstants.ROW_VALUE + TshipExcelConstants.EMPTY_SPACE + rowNumber + TshipExcelConstants.EMPTY_SPACE
							+ TshipExcelConstants.COD_PRIORITY3_NAME_VALIDATION_AIR + TshipExcelConstants.NEW_LINE);
				...
				&& !TshipLogisticPartnerUtil.containsLogisticPartnerName(priorityMaster.getAirPriorityMaster().getAirCodPriority4()))
		{
			writer.write(
					TshipExcelConstants.ROW_VALUE + TshipExcelConstants.EMPTY_SPACE + rowNumber + TshipExcelConstants.EMPTY_SPACE
							+ TshipExcelConstants.COD_PRIORITY4_NAME_VALIDATION_AIR + TshipExcelConstants.NEW_LINE);
				...
				&& !TshipLogisticPartnerUtil.containsLogisticPartnerName(priorityMaster.getAirPriorityMaster().getAirCodPriority5()))
		{
			writer.write(
					TshipExcelConstants.ROW_VALUE + TshipExcelConstants.EMPTY_SPACE + rowNumber + TshipExcelConstants.EMPTY_SPACE
							+ TshipExcelConstants.COD_PRIORITY5_NAME_VALIDATION_AIR + TshipExcelConstants.NEW_LINE);
	...
	private void validateSurPrepaidPriorities(final PriorityMaster priorityMaster, final FileWriter writer, final int rowNumber)
			throws IOException
	{
		if (priorityMaster.getSurfacePriorityMaster().getSurfacePrepaidPriority1().length() > 1 && !TshipLogisticPartnerUtil
				.containsLogisticPartnerName(priorityMaster.getSurfacePriorityMaster().getSurfacePrepaidPriority1()))
		{
			writer.write(
					TshipExcelConstants.ROW_VALUE + TshipExcelConstants.EMPTY_SPACE + rowNumber + TshipExcelConstants.EMPTY_SPACE
							+ TshipExcelConstants.PREPAID_PRIORITY1_NAME_VALIDATION_SURFACE + TshipExcelConstants.NEW_LINE);
		}
		else if (priorityMaster.getSurfacePriorityMaster().getSurfacePrepaidPriority2().length() > 1 && !TshipLogisticPartnerUtil
				.containsLogisticPartnerName(priorityMaster.getSurfacePriorityMaster().getSurfacePrepaidPriority2()))
		{
			writer.write(
					TshipExcelConstants.ROW_VALUE + TshipExcelConstants.EMPTY_SPACE + rowNumber + TshipExcelConstants.EMPTY_SPACE
							+ TshipExcelConstants.PREPAID_PRIORITY2_NAME_VALIDATION_SURFACE + TshipExcelConstants.NEW_LINE);
		}
		else if (priorityMaster.getSurfacePriorityMaster().getSurfacePrepaidPriority3().length() > 1 && !TshipLogisticPartnerUtil
				.containsLogisticPartnerName(priorityMaster.getSurfacePriorityMaster().getSurfacePrepaidPriority3()))
		{
			writer.write(
					TshipExcelConstants.ROW_VALUE + TshipExcelConstants.EMPTY_SPACE + rowNumber + TshipExcelConstants.EMPTY_SPACE
							+ TshipExcelConstants.PREPAID_PRIORITY3_NAME_VALIDATION_SURFACE + TshipExcelConstants.NEW_LINE);
		}
		else if (priorityMaster.getSurfacePriorityMaster().getSurfacePrepaidPriority4().length() > 1 && !TshipLogisticPartnerUtil
				.containsLogisticPartnerName(priorityMaster.getSurfacePriorityMaster().getSurfacePrepaidPriority4()))
		{
			writer.write(
					TshipExcelConstants.ROW_VALUE + TshipExcelConstants.EMPTY_SPACE + rowNumber + TshipExcelConstants.EMPTY_SPACE
							+ TshipExcelConstants.PREPAID_PRIORITY4_NAME_VALIDATION_SURFACE + TshipExcelConstants.NEW_LINE);
		}
	}
	...
	{
		if (priorityMaster.getSurfacePriorityMaster().getSurfaceCodPriority1().length() > 1 && !TshipLogisticPartnerUtil
				.containsLogisticPartnerName(priorityMaster.getSurfacePriorityMaster().getSurfaceCodPriority1()))
		{
			writer.write(
					TshipExcelConstants.ROW_VALUE + TshipExcelConstants.EMPTY_SPACE + rowNumber + TshipExcelConstants.EMPTY_SPACE
							+ TshipExcelConstants.COD_PRIORITY1_NAME_VALIDATION_SURFACE + TshipExcelConstants.NEW_LINE);
		}
		else if (priorityMaster.getSurfacePriorityMaster().getSurfaceCodPriority2().length() > 1 && !TshipLogisticPartnerUtil
				.containsLogisticPartnerName(priorityMaster.getSurfacePriorityMaster().getSurfaceCodPriority2()))
		{
			writer.write(
					TshipExcelConstants.ROW_VALUE + TshipExcelConstants.EMPTY_SPACE + rowNumber + TshipExcelConstants.EMPTY_SPACE
							+ TshipExcelConstants.COD_PRIORITY2_NAME_VALIDATION_SURFACE + TshipExcelConstants.NEW_LINE);
		}
		else if (priorityMaster.getSurfacePriorityMaster().getSurfaceCodPriority3().length() > 1 && !TshipLogisticPartnerUtil
				.containsLogisticPartnerName(priorityMaster.getSurfacePriorityMaster().getSurfaceCodPriority3()))
		{
			writer.write(
					TshipExcelConstants.ROW_VALUE + TshipExcelConstants.EMPTY_SPACE + rowNumber + TshipExcelConstants.EMPTY_SPACE
							+ TshipExcelConstants.COD_PRIORITY3_NAME_VALIDATION_SURFACE + TshipExcelConstants.NEW_LINE);
		}
		else if (priorityMaster.getSurfacePriorityMaster().getSurfaceCodPriority4().length() > 1 && !TshipLogisticPartnerUtil
				.containsLogisticPartnerName(priorityMaster.getSurfacePriorityMaster().getSurfaceCodPriority4()))
		{
			writer.write(
					TshipExcelConstants.ROW_VALUE + TshipExcelConstants.EMPTY_SPACE + rowNumber + TshipExcelConstants.EMPTY_SPACE
							+ TshipExcelConstants.COD_PRIORITY4_NAME_VALIDATION_SURFACE + TshipExcelConstants.NEW_LINE);
		}
		else
		{
			result = true;
