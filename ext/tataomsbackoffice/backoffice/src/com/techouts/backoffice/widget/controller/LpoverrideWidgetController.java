...
public class LpoverrideWidgetController
{
	...
	private List<String> lpList; //active logistcs Partners
	...
	public void init()
	{
		...
		lpList = (List) logisticsFacade.getAll();
	...
	public void lpAwbSearch()
	{
		...
		try
		{
			...
			listOfTransactions = orderLogisticsUpdateFacade.getOrderLogisticsInfo(lpAwbSearch).getTransactionInfo();
	 ...
	 *           the lpList to set
	 */
	public void setLpList(final List<String> lpList)
	{
		this.lpList = lpList;
	}
