...
public class LpAwbBulkDataUploadController extends DefaultWidgetController
{
	...
	public void selectHomeUploadZip(final UploadEvent uploadEvent) throws InterruptedException, IOException
	{
		...
		try
		{
			...
			{
				tempFile = TataomsbackofficeConstants.LPAWB_RETURN_FiLE_PREFIX.concat(TimeStamp).concat(CSV);
				tempFilePath = TataomsbackofficeConstants.LPAWB_RETURN_FILE_PATH;
			}
			else
			{
	...
	private void sendBulkDatatoOms(final File destFile, final String transactionType)
	{
