...
/**
 * This is the extension manager of the Cacheclear extension.
 */
public class CacheclearManager extends GeneratedCacheclearManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CacheclearManager.class.getName());
	...
	{
		return (CacheclearManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CacheclearConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CacheclearManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CacheclearManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CacheclearManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CacheclearManager called, current tenant: " + getTenant().getTenantID());
		}
	}
