...
import com.tul.mpl.constants.DashboardConstants;



/**
 * This is the extension manager of the Dashboard extension.
 */
public class DashboardManager extends GeneratedDashboardManager
{
	...
	{
		return (DashboardManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				DashboardConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public DashboardManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of DashboardManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of DashboardManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of DashboardManager called, current tenant: " + getTenant().getTenantID());
		}
	}
