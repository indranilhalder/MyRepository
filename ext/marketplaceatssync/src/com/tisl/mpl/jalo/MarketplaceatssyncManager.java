...
/**
 * This is the extension manager of the Marketplaceatssync extension.
 */
public class MarketplaceatssyncManager extends GeneratedMarketplaceatssyncManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MarketplaceatssyncManager.class.getName());
	 ...
	 */
	public static MarketplaceatssyncManager getInstance()
	{
		return (MarketplaceatssyncManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MarketplaceatssyncConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MarketplaceatssyncManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MarketplaceatssyncManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MarketplaceatssyncManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MarketplaceatssyncManager called, current tenant: " + getTenant().getTenantID());
		}
	}
