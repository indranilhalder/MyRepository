...
/**
 * This is the extension manager of the Marketplacecoupon extension.
 */
public class MarketplacecouponManager extends GeneratedMarketplacecouponManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MarketplacecouponManager.class.getName());
	 ...
	 */
	public static MarketplacecouponManager getInstance()
	{
		return (MarketplacecouponManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MarketplacecouponConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MarketplacecouponManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MarketplacecouponManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MarketplacecouponManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MarketplacecouponManager called, current tenant: " + getTenant().getTenantID());
		}
	}
