 ...
 *
 */
public class CouponSellerRestSaveInterceptor implements PrepareInterceptor<SellerRestrictionModel>
{
	/**
	 *
	 */
	 ...
	 */
	@Override
	public void onPrepare(final SellerRestrictionModel sellerModel, final InterceptorContext arg1) throws InterceptorException
	{
		try
		{

			if (null != sellerModel && StringUtils.isNotEmpty(sellerModel.getSellerCodeList()))
			{
