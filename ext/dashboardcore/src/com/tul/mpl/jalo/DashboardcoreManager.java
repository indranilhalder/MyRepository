...
import com.tul.mpl.constants.DashboardcoreConstants;



/**
 * This is the extension manager of the Dashboardcore extension.
 */
public class DashboardcoreManager extends GeneratedDashboardcoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(DashboardcoreManager.class.getName());
	 ...
	 */
	public static DashboardcoreManager getInstance()
	{
		return (DashboardcoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				DashboardcoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public DashboardcoreManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of DashboardcoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of DashboardcoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of DashboardcoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
