 ...
 */
public class AssociationLeadUssidConverter extends DefaultImpexConverter
{
	...
	@Autowired
	private MplleadVariantWeightService MplleadVariantWeightService;

	/**
	 * @return the mplleadVariantWeightService
	 */
	public MplleadVariantWeightService getMplleadVariantWeightService()
	{
		return MplleadVariantWeightService;
	}

	/**
	 * @param mplleadVariantWeightService
	 *           the mplleadVariantWeightService to set
	 */
	public void setMplleadVariantWeightService(final MplleadVariantWeightService mplleadVariantWeightService)
	{
		MplleadVariantWeightService = mplleadVariantWeightService;
	}
	...
	public String convert(final Map<Integer, String> row, final Long sequenceId)
	{
		...
		MplleadVariantWeightService.updateSellerinfoHasvariant(row);
