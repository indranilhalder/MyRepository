...
public class CachedCustomPromotionOrderAdjustTotalAction extends GeneratedCachedCustomPromotionOrderAdjustTotalAction implements
		JaloOnlyItem
{
	private static final Logger LOG = Logger.getLogger(CachedCustomPromotionOrderAdjustTotalAction.class.getName());
			...
			throws JaloBusinessException
	{
		...
		try
		{
			final CachedCustomPromotionOrderAdjustTotalAction newOne = (CachedCustomPromotionOrderAdjustTotalAction) cl
					.newInstance();
	...
	AbstractPromotionAction deepClone(final SessionContext ctx)
	{
		try
		{
			...
			final ComposedType type = TypeManager.getInstance().getComposedType(CustomPromotionOrderAdjustTotalAction.class);
			try
			{
