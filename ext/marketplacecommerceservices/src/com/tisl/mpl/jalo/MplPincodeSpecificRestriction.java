...
public class MplPincodeSpecificRestriction extends GeneratedMplPincodeSpecificRestriction
{
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger(MplPincodeSpecificRestriction.class.getName());
