...
public class CachedCustomShippingChargesPromotionAdjustAction extends GeneratedCachedCustomShippingChargesPromotionAdjustAction
		implements JaloOnlyItem
{
	private static final Logger LOG = Logger.getLogger(CachedCustomShippingChargesPromotionAdjustAction.class.getName());
			...
			throws JaloBusinessException
	{
		...
		try
		{
			final CachedCustomShippingChargesPromotionAdjustAction newOne = (CachedCustomShippingChargesPromotionAdjustAction) cl
					.newInstance();
	...
	AbstractPromotionAction deepClone(final SessionContext ctx)
	{
		try
		{
			...
			final ComposedType type = TypeManager.getInstance().getComposedType(CustomShippingChargesPromotionAdjustAction.class);
			try
			{
