...
public class CachedCustomPromotionOrderEntryAdjustAction extends GeneratedCachedCustomPromotionOrderEntryAdjustAction implements
		JaloOnlyItem
{
	private static final Logger LOG = Logger.getLogger(CachedCustomPromotionOrderEntryAdjustAction.class.getName());
			...
			throws JaloBusinessException
	{
		...
		try
		{
			final CachedCustomPromotionOrderEntryAdjustAction newOne = (CachedCustomPromotionOrderEntryAdjustAction) cl
					.newInstance();
	...
	AbstractPromotionAction deepClone(final SessionContext ctx)
	{
		try
		{
			...
			final ComposedType type = TypeManager.getInstance().getComposedType(CustomPromotionOrderEntryAdjustAction.class);
			try
			{
