...
public class MplSearchResponseOfferCategoryIDPopulator<STATE, ITEM, CATEGORY>
		implements Populator<SolrSearchResponse, ProductCategorySearchPageData<STATE, ITEM, CATEGORY>>
{
	...
	{
		target.setOfferCategoryID(source.getRequest().getSearchQueryData().getOfferCategoryID());
	}
}