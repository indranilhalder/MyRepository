...
/**
 * @author TCS This populator is used only to calculate promotion related calculation TISPT-104
 *
 */
public class DefaultExtendedPromoCartPopulator extends CartPopulator
{

	private static final Logger LOG = Logger.getLogger(DefaultExtendedPromoCartPopulator.class);
