 ...
 *
 */
public class ChangeDeliveryAddressServiceImpl implements MplChangeDeliveryAddressService
{
	
	@Autowired
	private MplSellerInformationService mplSellerInformationService;
	private static final Logger LOG = Logger.getLogger(ChangeDeliveryAddressServiceImpl.class);

	@Override
	public boolean changeDeliveryAddressCallToOMS(final String code, final AddressModel newDeliveryAddress)
	{
