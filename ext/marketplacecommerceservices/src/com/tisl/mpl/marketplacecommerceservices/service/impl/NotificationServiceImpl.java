...
public class NotificationServiceImpl implements NotificationService
{
	...
	//SONAR FIX
	/*
	 * @Autowired private BaseSiteService baseSiteService;
	 *
	 *
	 * @Autowired private BaseStoreService baseStoreService;
	 *
	 * @Autowired private CommonI18NService commonI18NService;
	 */
			...
			throws JAXBException
	{
		...
		if (orderDetails.getStatus().equals(OrderStatus.PAYMENT_PENDING))
		{
			...
			{
				LOG.error("Exception during sending mail or SMS from PaymentPending1  >> " + e1.getMessage());
			}
		}
		return flag;
	}
	...
	public void triggerEmailAndSmsOnPaymentFailed(final OrderModel orderDetails, final String trackorderurl) throws JAXBException
	{
		if (orderDetails.getStatus().equals(OrderStatus.PAYMENT_FAILED))
		{
			...
			{
				LOG.error("Exception during sending mail or SMS 1 >> " + e1.getMessage());
			}
		}
	}
	...
	public void triggerEmailAndSmsOnPaymentTimeout(final OrderModel orderDetails, final String trackorderurl) throws JAXBException
	{
		if (orderDetails.getStatus().equals(OrderStatus.PAYMENT_TIMEOUT))
		{
			...
			{
				LOG.error("Exception during sending mail or SMS 2 >> " + e1.getMessage());
			}
		}
	}
	...
	public void saveToVoucherStatusNotification(final VoucherModel voucher) throws EtailNonBusinessExceptions
	{
		try
		{
			...
			if (voucher instanceof PromotionVoucherModel)
			{
				...
				final String voucherIndentifier = promoVoucher.getCode();
	...
	//SONAR FIX
	/*
	 * private List<VoucherStatusNotificationModel> getModelForVoucherIdentifier(final String voucherCode) throws
	 * EtailNonBusinessExceptions { return getNotificationDao().getModelForVoucherIdentifier(voucherCode); }
	 */
