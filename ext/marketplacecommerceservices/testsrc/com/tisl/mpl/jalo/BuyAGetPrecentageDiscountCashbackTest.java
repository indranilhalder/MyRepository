...
public class BuyAGetPrecentageDiscountCashbackTest extends MplServicelayerTest
{
	...
	private void promotionSetup(final ProductModel product)
	{
		...
		final BuyAGetPrecentageDiscountCashbackModel dicountModel = new BuyAGetPrecentageDiscountCashbackModel();
		dicountModel.setCode("CashBackPromotion");
		dicountModel.setTitle("Buy 1 get 10 Percent Cashback");
		dicountModel.setChannel(channelList);
		dicountModel.setQuantity(Long.valueOf(1));
		dicountModel.setPriority(Integer.valueOf(1000));
		dicountModel.setDescription("Buy 1 get 10 Percent Cashback");
	...
	public void tearDown()
	{
		...
		final AbstractPromotionModel promotion = (AbstractPromotionModel) flexibleSearchService
				.search("SELECT {PK} FROM {AbstractPromotion} WHERE {code}='CashBackPromotion'").getResult().get(0);
