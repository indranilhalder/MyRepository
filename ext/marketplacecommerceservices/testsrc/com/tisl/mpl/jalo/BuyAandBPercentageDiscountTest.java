...
@UnitTest
public class BuyAandBPercentageDiscountTest extends AbstractPromotionTest
{
	...
	public void setUp() throws Exception
	{
		...
		firstProduct.add(p);
		buyAandBPrecentageDiscount.setProducts(firstProduct);
		...
		secondProduct.add(p);
		buyAandBPrecentageDiscount.setSecondProducts(secondProduct);

		buyAandBPrecentageDiscount.setPercentageDiscount(10);
		buyAandBPrecentageDiscount.setPercentageOrAmount(true);
		buyAandBPrecentageDiscount.setDiscountPrices(null);
		buyAandBPrecentageDiscount.setMaxDiscount(1000.0);
