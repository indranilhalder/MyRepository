...
public class BuyAgetBFreePercentageDiscountTest extends MplServicelayerTest
{

	private static final Logger LOG = Logger.getLogger(BuyAgetBFreePercentageDiscountTest.class);
