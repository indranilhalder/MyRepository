...
public class BuyAGetPercentageDiscountOnBTest extends MplServicelayerTest
{

	private static final Logger LOG = Logger.getLogger(BuyAGetPercentageDiscountOnBTest.class);
	...
	private void promotionSetup(final ProductModel product, final ProductModel secProduct)
	{
		...
		final BuyAGetPercentageDiscountOnBModel dicountModel = new BuyAGetPercentageDiscountOnBModel();
		dicountModel.setCode("BuyAGetPercentageoffOnB");
		dicountModel.setTitle("Attractive Offer");
		dicountModel.setChannel(channelList);
		dicountModel.setPriority(Integer.valueOf(1000));
		dicountModel.setDescription("Attractive Offer");
	...
	public void tearDown()
	{
		...
		final AbstractPromotionModel promotion = (AbstractPromotionModel) flexibleSearchService
				.search("SELECT {PK} FROM {AbstractPromotion} WHERE {code}='BuyAGetPercentageoffOnB'").getResult().get(0);
