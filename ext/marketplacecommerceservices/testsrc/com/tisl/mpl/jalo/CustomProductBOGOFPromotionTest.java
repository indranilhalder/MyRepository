...
public class CustomProductBOGOFPromotionTest extends MplServicelayerTest
{

	private static final Logger LOG = Logger.getLogger(CustomProductBOGOFPromotionTest.class);
	...
	public void setUp() throws Exception
	{
		...
		getCatalogData();
		product1 = getProductData("987654321");
		setUser("2000000011");
		setCurrency("INR");
	...
	private void enablePromotion()
	{
		...
		final AbstractPromotionModel promotion = (AbstractPromotionModel) flexibleSearchService
				.search("SELECT {PK} FROM {AbstractPromotion} WHERE {code}='BOGOFPromotion'").getResult().get(0);
	...
	private CartModel getCart()
	{
		...
		cartSvc.addNewEntry(cart, product1, 2, product1.getUnit());
