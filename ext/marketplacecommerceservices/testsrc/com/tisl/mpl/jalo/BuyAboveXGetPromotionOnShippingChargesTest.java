 ...
 *
 */
public class BuyAboveXGetPromotionOnShippingChargesTest
{
	@Resource
	...
	public void setUp() throws Exception
	{
		...
		product = productService.getProductForCode(version, "987654341");
	}
	...
	private BuyAboveXGetPromotionOnShippingChargesModel preparePromotion(final String code, final double thresholdTotals,
			final Double percentageDiscount, PromotionGroupModel promotionGroup, final double discountPrices)
	{
		final BuyAboveXGetPromotionOnShippingChargesModel promo = new BuyAboveXGetPromotionOnShippingChargesModel();
		promo.setCode(code);
