...
public class BuyAboveXGetPromotionOnShippingChargesTest extends MplServicelayerTest
{

	private static final Logger LOG = Logger.getLogger(BuyAGetPromotionOnShippingChargesTest.class);
	...
	private void enablePromotion()
	{
		...
		if (promotion instanceof BuyAboveXGetPromotionOnShippingChargesModel)
		{
			...
			discountModel.setThresholdTotals(createPriceRow(currency, 1000));
