 ...
 *
 */
public class BuyAGetPromotionOnShippingChargesTest extends AbstractPromotionTest
{
	private static final Logger LOG = Logger.getLogger(BuyAgetPercentageDiscountTest.class);
	...
	public void setUp() throws Exception
	{
		...
		buyAGetPromotionOnShippingCharges.setProducts(product);
		buyAGetPromotionOnShippingCharges.setQuantity(2);
		buyAGetPromotionOnShippingCharges.setPercentageDiscount(10);
		buyAGetPromotionOnShippingCharges.getDiscTypesOnShippingCharges();
	...
	private void testPromotionBody() throws CalculationException
	{
		...
		assertEquals("one product with promotion", 900, cart.getTotalPrice().doubleValue(), 0.01);
		...
		calculationService.calculate(cart);
		assertEquals("two products with promotion", 900, cart.getTotalPrice().doubleValue(), 0.01);
