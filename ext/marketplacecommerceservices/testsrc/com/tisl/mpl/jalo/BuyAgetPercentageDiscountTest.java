...
public class BuyAgetPercentageDiscountTest extends MplServicelayerTest
{
	...
	private void promotionSetup(final ProductModel product)
	{
		...
		final BuyAPercentageDiscountModel dicountModel = new BuyAPercentageDiscountModel();
		dicountModel.setCode("DiscountPromotion");
		dicountModel.setTitle("Buy 1 get 10 Percent off");
		dicountModel.setChannel(channelList);
		dicountModel.setQuantity(Long.valueOf(1));
		dicountModel.setPriority(Integer.valueOf(1000));
		dicountModel.setDescription("Buy 1 get 10 Percent off");
	...
	public void tearDown()
	{
		...
		final AbstractPromotionModel promotion = (AbstractPromotionModel) flexibleSearchService
				.search("SELECT {PK} FROM {AbstractPromotion} WHERE {code}='DiscountPromotion'").getResult().get(0);
