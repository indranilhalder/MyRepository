...
public class BuyAgetPercentageDiscountTest extends AbstractPromotionServiceTest
{
	...
	public void setUp() throws Exception
	{
		...
		buyAPrecentageDiscount.setProducts(product);
		buyAPrecentageDiscount.setQuantity(2);
		buyAPrecentageDiscount.setPercentageDiscount(10);
		//buyAPrecentageDiscount.setDiscountPrices(createPriceRow(currency, 100));
		buyAPrecentageDiscount.setPercentageOrAmount(true);
		buyAPrecentageDiscount.setMaxDiscountVal(100);
