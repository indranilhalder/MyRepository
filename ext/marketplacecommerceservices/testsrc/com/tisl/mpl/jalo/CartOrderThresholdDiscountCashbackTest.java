...
public class CartOrderThresholdDiscountCashbackTest extends MplServicelayerTest
{
	private static final Logger LOG = Logger.getLogger(CartOrderThresholdDiscountCashbackTest.class);
	...
	private void promotionSetup()
	{
		...
		final CartOrderThresholdDiscountCashbackModel discountModel = new CartOrderThresholdDiscountCashbackModel();
		discountModel.setCode("CartPromotionCashback");
		discountModel.setTitle("Buy Over 1000 Get 10 Percent Off Cashback");
		discountModel.setChannel(channelList);
		discountModel.setPriority(Integer.valueOf(500));
		discountModel.setDescription("Buy Over 1000 Get 10 Percent Off Cashback");
