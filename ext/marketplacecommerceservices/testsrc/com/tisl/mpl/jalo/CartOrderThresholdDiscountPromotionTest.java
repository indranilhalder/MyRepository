...
public class CartOrderThresholdDiscountPromotionTest extends ServicelayerTransactionalTest
{
	...
	private CartOrderThresholdDiscountPromotionModel preparePromotion(final String code, final double thresholdTotals,
			final Double percentageDiscount, PromotionGroupModel promotionGroup, final double discountPrices)
	{
		final CartOrderThresholdDiscountPromotionModel promo = new CartOrderThresholdDiscountPromotionModel();
		promo.setCode(code);
