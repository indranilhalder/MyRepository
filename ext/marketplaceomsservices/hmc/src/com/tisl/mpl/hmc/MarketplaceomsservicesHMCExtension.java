...
/**
 * Provides necessary meta information about the marketplaceomsservices hmc extension.
 * 
 * 
 * @version ExtGen v5.5.1.0
 */
public class MarketplaceomsservicesHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(MarketplaceomsservicesHMCExtension.class.getName());
