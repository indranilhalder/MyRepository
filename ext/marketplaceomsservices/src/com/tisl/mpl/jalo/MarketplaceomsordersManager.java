...
/**
 * This is the extension manager of the Marketplaceomsorders extension.
 */
public class MarketplaceomsordersManager extends GeneratedMarketplaceomsservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MarketplaceomsordersManager.class.getName());
	 ...
	 */
	public static MarketplaceomsordersManager getInstance()
	{
		return (MarketplaceomsordersManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MarketplaceomsordersConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MarketplaceomsordersManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MarketplaceomsordersManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MarketplaceomsordersManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MarketplaceomsordersManager called, current tenant: " + getTenant().getTenantID());
		}
	}
