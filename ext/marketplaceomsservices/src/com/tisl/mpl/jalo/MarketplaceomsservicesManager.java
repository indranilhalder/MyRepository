...
/**
 * This is the extension manager of the Marketplaceomsservices extension.
 */
public class MarketplaceomsservicesManager extends GeneratedMarketplaceomsservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MarketplaceomsservicesManager.class.getName());
	 ...
	 */
	public static MarketplaceomsservicesManager getInstance()
	{
		return (MarketplaceomsservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MarketplaceomsservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MarketplaceomsservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MarketplaceomsservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MarketplaceomsservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MarketplaceomsservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
