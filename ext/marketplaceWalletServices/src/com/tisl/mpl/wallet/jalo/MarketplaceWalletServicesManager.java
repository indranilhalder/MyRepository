...
/**
 * This is the extension manager of the MarketplaceWalletServices extension.
 */
public class MarketplaceWalletServicesManager extends GeneratedMarketplaceWalletServicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MarketplaceWalletServicesManager.class.getName());
	 ...
	 */
	public static MarketplaceWalletServicesManager getInstance()
	{
		return (MarketplaceWalletServicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MarketplaceWalletServicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MarketplaceWalletServicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MarketplaceWalletServicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MarketplaceWalletServicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MarketplaceWalletServicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
