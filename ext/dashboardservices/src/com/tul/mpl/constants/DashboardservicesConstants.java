...
/**
 * Global class for all Dashboardservices constants. You can add global constants for your extension into this class.
 */

@SuppressWarnings(
{ "PMD", "deprecation" })
public final class DashboardservicesConstants extends GeneratedDashboardservicesConstants
{
	public static final String EXTENSIONNAME = "dashboardservices";

	private DashboardservicesConstants()
	{
	...
	public static final String SALES_REPORT_QUERY_START = "SELECT {" + OrderModel.PK + "} FROM {" + OrderModel._TYPECODE
			+ "} WHERE " + "{" + OrderModel.CREATIONTIME + "} BETWEEN ?fromDate AND sysdate AND {" + OrderModel.TYPE
	...
	public static final String SALES_REPORT_QUERY_START_END = "SELECT {" + OrderModel.PK + "} FROM {" + OrderModel._TYPECODE
			+ "} WHERE {" + OrderModel.CREATIONTIME + "} BETWEEN ?startDate AND ?endDate AND {" + OrderModel.TYPE
			+ "}=?type order by {" + OrderModel.CODE + "} desc";
