...
import com.tul.mpl.constants.DashboardservicesConstants;



/**
 * This is the extension manager of the Dashboardservices extension.
 */
public class DashboardservicesManager extends GeneratedDashboardservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(DashboardservicesManager.class.getName());
	 ...
	 */
	public static DashboardservicesManager getInstance()
	{
		return (DashboardservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				DashboardservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public DashboardservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of DashboardservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of DashboardservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of DashboardservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
