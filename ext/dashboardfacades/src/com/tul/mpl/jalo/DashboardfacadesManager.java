...
import com.tul.mpl.constants.DashboardfacadesConstants;



/**
 * This is the extension manager of the Dashboardfacades extension.
 */
public class DashboardfacadesManager extends GeneratedDashboardfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(DashboardfacadesManager.class.getName());
	 ...
	 */
	public static DashboardfacadesManager getInstance()
	{
		return (DashboardfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				DashboardfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public DashboardfacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of DashboardfacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of DashboardfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of DashboardfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
