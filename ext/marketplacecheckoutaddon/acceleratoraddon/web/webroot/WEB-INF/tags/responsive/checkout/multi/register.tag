	...
	<form:hidden path="affiliateId" class="add_edit_delivery_address_id" />
		...
		<c:url value="/tncmytatarewards" var="tncmytatarewards" />
		 <div id="checkBox">
				...
				<label for="check_MyRewards">I want to be a part of <a href="${mytatarewards }" target="_blank" class="tata-rewards">Tata Treats Program</a> (You can opt-out anytime) By opting in I agree to <a href="${tncmytatarewards }" target="_blank"> T&C </a> of Tata Treats.</label>
		</div> 
   ...
   <!--  <h4>Please sign in using one of the following providers:</h4><br /><br /> -->
    ...
    <script type="text/javascript">
        gigya.socialize.showLoginUI({
            ...
            ,containerID: 'loginDivRegisterCheckOut' // The component will embed itself inside the loginDiv Div
            ,cid:''
