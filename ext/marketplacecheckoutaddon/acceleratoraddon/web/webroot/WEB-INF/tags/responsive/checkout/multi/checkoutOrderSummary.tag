...
<%@ taglib prefix="cartAmount" tagdir="/WEB-INF/tags/addons/marketplacecheckoutaddon/responsive/checkout/multi" %>
...
<div class="col-sm-4 col-md-3 col-lg-4">
	<div class="checkout-order-summary">
		<ycommerce:testId code="orderSummary">
			...
			<cartAmount:orderTotalsSummary cartData="${cartData}" showTaxEstimate="${showTaxEstimate}" showTax="${showTax}" />
		</ycommerce:testId>
	</div>
