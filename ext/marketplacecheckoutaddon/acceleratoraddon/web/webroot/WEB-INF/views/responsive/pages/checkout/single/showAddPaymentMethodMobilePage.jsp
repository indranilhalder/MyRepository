...
<spring:url value="/checkout/multi/debitTermsAndConditions"
	var="getDebitTermsAndConditionsUrl" />


<div class="alert alert-danger alert-dismissable"
	id="juspayconnErrorDiv">
	<!-- TPR-629 changes for error -->
...
<script type="text/javascript" async="true"
	src="https://elistva.com/api/script.js?aid=${account_id}&sid=${session_id}">
	</script>

<noscript>
	<p
		style="background:url(//elistva.com/api/assets/clear.png?aid=${account_id}&sid=${session_id}"></p>
</noscript>

<object type="application/x-shockwave-flash"
	data="//elistva.com/api/udid.swf?aid=${account_id}&sid=${session_id}"
	width="1" height="1">
	<param name="movie"
		value="//elistva.com/api/udid.swf?aid=${account_id}&sid=${session_id}" />
</object>
<!-- TISCR-421 Ends -->
...
<div class="checkout-content checkout-payment cart checkout wrapper">
												...
												<div class="card card-num">
													<div class="radio">
														...
														<input type="radio" data-id="savedCCard"
															...
															id="cc${status.index}" value="${map.value.cardToken}" onclick="ACC.singlePageCheckout.onPaymentModeSelection('Credit Card');" />
												...
												<div class="card card-num">
													<div class="radio">
														...
														<input type="radio" data-id="savedDCard" name="debitCards"
															...
															id="dc${status.index}" value="${map.value.cardToken}" onclick="ACC.singlePageCheckout.onPaymentModeSelection('Debit Card');"/>
			...
			<ul class="tabs">
						...
						<c:choose>
							<c:when test="${map.key eq 'Credit Card'}">
								...
								<li class="paymentModeMobile"><span
									id="viewPaymentCreditMobile" onclick="ACC.singlePageCheckout.onPaymentModeSelection('Credit Card');"> <spring:theme
				...
				<li id="card">
					<ul class="product-block blocks">
						...
						<li id="newCardCC" class="item new-form active">
							<form class="juspay_inline_form new-card" id="payment_form"
								autocomplete="off">
								<div id="newMaestroMessage">
									<spring:theme
										code="checkout.multi.paymentMethod.addPaymentDetails.maestroMsg" />
								</div>
								<input type="hidden" class="merchant_id" id="merchant_id"
									value="${merchantID}" /> <input type="hidden" class="order_id"
									id="order_id_new" />
								<!-- <input type="hidden" class="is_emi" id="is_emi" />
				                  		<input type="hidden" class="emi_tenure" id="emi_tenure" />
				                  		<input type="hidden" class="emi_bank" id="emi_bank"> -->
								...
								<div class="radio creditDebitLabelRadio">
									<input type="radio" data-id="newCCard" id="creditLabel" /> <label
										for="creditLabel" class="numbers creditLabel"
										data-id="newCCard"><span>New Card</span></label>
								</div>
								<div class="card-group">
									<div class="form-group">
										<fieldset>
											<div class="full account-only">
												<label><spring:theme code="text.cardtype" /> *</label> <select>
									...
									<input class="last" placeholder="4444" id="cardNo4">
												...
												<label class="control-label"><spring:theme
														code="checkout.multi.paymentMethod.addPaymentDetails.cardNo" /></label>
												<input type="text" class="card_number" id="cardNo"
													maxlength="16" autocomplete="off"
													placeholder="Enter your card number">
												<!-- <input type="hidden" class="card_number" value="" /> -->
												<input type="hidden" id="cardType" disabled="disabled" /> <span
													class="error-message" id="cardNoError"></span>
											</div>

											<div class="controls full">
												<label class="control-label"><spring:theme
														code="checkout.multi.paymentMethod.addPaymentDetails.cardName" /></label>
												<input type="text" name="memberName"
													class="name_on_card name-card" maxlength="79"
													autocomplete="off"> <span class="error-message"
													id="memberNameError"></span>
											</div>
											...
											<div class="controls full exp ">
												<label class="control-label expires"> <spring:theme
													...
													<option value="01"><spring:theme
															code="checkout.multi.paymentMethod.addPaymentDetails.01" /></option>
													<option value="02"><spring:theme
															code="checkout.multi.paymentMethod.addPaymentDetails.02" /></option>
													<option value="03"><spring:theme
															code="checkout.multi.paymentMethod.addPaymentDetails.03" /></option>
													<option value="04"><spring:theme
															code="checkout.multi.paymentMethod.addPaymentDetails.04" /></option>
													<option value="05"><spring:theme
															code="checkout.multi.paymentMethod.addPaymentDetails.05" /></option>
													<option value="06"><spring:theme
															code="checkout.multi.paymentMethod.addPaymentDetails.06" /></option>
													<option value="07"><spring:theme
															code="checkout.multi.paymentMethod.addPaymentDetails.07" /></option>
													<option value="08"><spring:theme
															code="checkout.multi.paymentMethod.addPaymentDetails.08" /></option>
													<option value="09"><spring:theme
															code="checkout.multi.paymentMethod.addPaymentDetails.09" /></option>
													<option value="10"><spring:theme
															code="checkout.multi.paymentMethod.addPaymentDetails.10" /></option>
													<option value="11"><spring:theme
															code="checkout.multi.paymentMethod.addPaymentDetails.11" /></option>
													<option value="12"><spring:theme
															code="checkout.multi.paymentMethod.addPaymentDetails.12" /></option>
												</select>
												...
												<select class="card_exp_year" name="expyy">
													...
													<c:forEach var="i" begin="${currentyear}"
														end="${currentyear + noOfYearsFromCurrentYear}">
														<option value="${i}">${i}</option>
													</c:forEach>
												</select> <span class="error-message" id="expYYError"></span>
											</div>

											<div class="controls full cvv">

												<input type="hidden" id="cvvHelpContent"
													value="<spring:theme code="checkout.multi.paymentMethod.addPaymentDetails.CVVHelpContent"/>">
												<input type="hidden" id="cvvHelpContent" value="${cvvHelp}">
												<label class="control-label"><spring:theme
														code="checkout.multi.paymentMethod.addPaymentDetails.CVV" /><span
													class="cvv_mobile"> [?]</span></label> <input type="password"
													autocomplete="new-password" class="security_code span1"
													name="cvv" maxlength="4" /> <a href="#cvvHelpText"
													class="cvvHelp" id="cvvHelp"></a> <span
													class="error-message" id="cvvError"></span>
											</div>
										</fieldset>
										<div class="controls remember" id="billingAddress">
												...
												<c:when test="${isCart eq true}">
													<c:forEach var="cartItem" items="${cartData.entries}">
														<c:set var="deliveryMode"
															value="${cartItem.mplDeliveryMode.code}" />
											...
											<c:if test="${flag eq true}">
												<input type="checkbox" id="sameAsShipping"
													name="billing-shipping" checked="checked" />
												<label for="sameAsShipping"><spring:theme
														code="checkout.multi.paymentMethod.addPaymentDetails.sameAsShipping" /></label>
											</c:if>
											<fieldset>
												<div class="half">
													<label><spring:theme code="text.first.name" /></label> <input
														type="text" id="firstName" required="required"
														maxlength="40"> <span class="error-message"
														id="firstNameError"></span>
												</div>
												<div class="half">
													<label><spring:theme code="text.last.name" /></label> <input
												...
												<div class="full">
													<label><spring:theme code="text.city" /></label> <input
														type="text" id="city" required="required" maxlength="40">
													<span class="error-message" id="cityError"></span>
												</div>
												<div class="half">
													<label><spring:theme code="text.state" /></label> <input
														type="text" id="state" required="required" maxlength="40">
													<span class="error-message" id="stateError"></span>
												</div>
												<div class="half">
													<label><spring:theme code="text.country" /></label> <select
														id="country">
												...
												<div class="full">
													<label><spring:theme code="text.pincode" /></label> <input
														type="text" id="pincode" maxlength="10"
														onchange="validatePin()"><span
														class="error-message" id="pinError"></span>
												</div>
											</fieldset>
										</div>
										<div class="controls remember">
											<input type="checkbox" class="juspay_locker_save checkbox"
												id="save-card" name="save-card" /><label for="save-card"><spring:theme
													code="checkout.multi.paymentMethod.addPaymentDetails.saveCard" /></label>
										</div>
										<input type="hidden" class="redirect" value="${redirect}">
									</div>
								</div>
					...
					<c:if test="${map.value eq true}">
						<c:choose>
							<c:when test="${map.key eq 'Debit Card'}">
								...
								<li class="paymentModeMobile"><span
									id="viewPaymentDebitMobile"  onclick="ACC.singlePageCheckout.onPaymentModeSelection('Debit Card');"> <spring:theme
				...
				<li id="cardDebit">
					<ul class="product-block blocks">
						...
						<li id="debitCard" class="item new-form active">
							...
							<form class="juspay_inline_form new-card" id="debit_payment_form"
								autocomplete="off">
								...
								<input type="hidden" id="ebsDownCheck" value="${ebsDownCheck}" />
								<div class="radio creditDebitLabelRadio">
									<input type="radio" data-id="newDCard" id="debitLabel" /> <label
										for="debitLabel" data-id="newDCard" class="numbers debitLabel"
										data-id="newDCard"><span>New Card</span></label>
								</div>
								<!-- <p>NEW CARD</p> -->
								<div class="card-group">
									<div class="form-group">
										<fieldset>
											...
											<div class="controls full">
												...
												<input type="text" class="card_number" id="cardNoDc"
													maxlength="16" autocomplete="off"
													placeholder="Enter your card number"> <input
													type="hidden" id="cardTypeDc" disabled="disabled" /> <span
													class="error-message" id="cardNoErrorDc"></span>
											</div>
											...
											<div class="controls full exp">
												...
												</select> <span class="error-message" id="expYYErrorDc"></span>
											</div>
											...
											<div class="controls full cvv">
												...
												<label class="control-label"><spring:theme
													...
													name="cvv" maxlength="4" /> <a href="#cvvHelpText"
													class="cvvHelp" id="cvvHelp"></a> <span
													class="error-message" id="cvvErrorDc"></span>
											</div>
										</fieldset>
										<%-- <div class="controls remember" id="billingAddress">
										...
										<div class="controls remember">
											<input type="checkbox" class="juspay_locker_save checkbox"
												id="save-card-dc" name="save-card" /><label
												for="save-card-dc"><spring:theme
													code="checkout.multi.paymentMethod.addPaymentDetails.saveCard" /></label>
										</div>
										<input type="hidden" class="redirect" value="${redirect}">
									</div>
					...
					<c:if test="${map.value eq true}">
						<c:choose>
							<c:when test="${map.key eq 'Netbanking'}">
								...
								<li class="paymentModeMobile"><span
									id="viewPaymentNetbankingMobile" onclick="ACC.singlePageCheckout.onPaymentModeSelection('Netbanking');"> <spring:theme
				...
				<li id="netbanking">
					...
					<div class="nbAjaxError error-message">
						<spring:theme
							code="checkout.multi.paymentMethod.netbanking.AjaxError" />
					</div> <!-- Terms & Conditions Link -->
					<div class="pay top-padding nbButton">
						<button type="button"
							class="make_payment button btn-block payment-button"
							id="make_nb_payment" onclick="submitNBForm()">
							<spring:theme
								code="checkout.multi.paymentMethod.addPaymentDetails.paymentButton" />
						</button>
						<div class="terms">
							<p class="redirect">
								<spring:theme code="text.secure.payment.gateway" />
							</p>
							<p onclick="teliumTrack()">
								<spring:theme
									code="checkout.multi.paymentMethod.selectMode.tnc.pretext" />
					...
					<c:if test="${map.value eq true}">
						<c:choose>
							<c:when test="${map.key eq 'EMI'}">
								<li class="paymentModeMobile"><span
									id="viewPaymentEMIMobile"  onclick="ACC.singlePageCheckout.onPaymentModeSelection('EMI');"> <spring:theme
					...
					<ul class="product-block emi blocks">
						<li class="item">
							<div class="bank-select">
								...
								</select> <span class="error-message" id="emiNoBankError">No Banks
									available.</span> <span class="error-message" id="emiPromoError"></span>
								...
								<p id="emiRangeError">
									<spring:theme
										code="checkout.multi.paymentMethod.emi.emiRangeError" />
								</p>
							</div>
							<div class="credit_for_emi"></div> <c:forEach var="map"
								items="${paymentModes}">
								<c:if test="${map.value eq true}">
									<c:choose>
										<c:when test="${map.key eq 'Credit Card'}">
											...
											<div id="cardEmi" style="display: none;">
												...
												<div id="newCardCCEmi" class="item new-form new-card active">
													...
													<form class="juspay_inline_form new-card"
														id="emi_payment_form" autocomplete="off">
														<div id="newMaestroMessage">
															<spring:theme code="checkout.multi.paymentMethod.addPaymentDetails.maestroMsg" />
														</div>
														<input type="hidden" class="merchant_id"
															id="merchant_id_emi" value="${merchantID}" /> <input
															type="hidden" class="order_id" id="order_id_new_emi" />
														<input type="hidden" class="is_emi" id="is_emi"
															value="true" /> <input type="hidden" class="emi_tenure"
															id="emi_tenure" /> <input type="hidden" class="emi_bank"
															id="emi_bank"> <input type="hidden"
															id="ebsDownCheck" value="${ebsDownCheck}" />
														<!-- <p>NEW CARD</p> -->
														<div class="card-group">
															<div class="form-group">
																<fieldset>
																	<div class="full account-only">
																		<label><spring:theme code="text.cardtype" />
																			*</label> <select>
																			<option><spring:theme code="text.select" /></option>
																		</select>
																	</div>
																	<div class="controls full">
																		<label class="control-label"><spring:theme
																				code="checkout.multi.paymentMethod.addPaymentDetails.cardNo" /></label>
																		<input type="text" class="card_number" id="cardNoEmi"
																			maxlength="16" autocomplete="off"
																			placeholder="Enter your card number">
																		<!-- <input type="hidden" class="card_number" value="" /> -->
																		<input type="hidden" id="cardTypeEmi"
																			disabled="disabled" /> <span class="error-message"
																			id="cardNoErrorEmi"></span>
																	</div>
																	...
																	<div class="controls full">
																		...
																		<input type="text" name="memberName"
																			...
																			class="error-message" id="memberNameErrorEmi"></span>
																	</div>
																	...
																	<div class="controls full exp ">
																		...
																		</select> <span class="error-message" id="expYYErrorEmi"></span>
																	</div>
																	...
																	<div class="controls full cvv">
																		...
																		<input type="hidden" id="cvvHelpContent"
																			...
																			class="security_code span1" name="cvv" maxlength="4" />
																...
																<div class="controls remember" id="billingAddressEmi">
																	...
																	<c:if test="${flag eq true}">
																		<input type="checkbox" id="sameAsShippingEmi"
																			name="billing-shipping" checked="checked" />
																		<label for="sameAsShippingEmi"><spring:theme
																				code="checkout.multi.paymentMethod.addPaymentDetails.sameAsShipping" /></label>
																	</c:if>
																	<fieldset>
																		<div class="half">
																			<label><spring:theme code="text.first.name" /></label>
																			<input type="text" id="firstNameEmi"
																				required="required" maxlength="40"> <span
																				class="error-message" id="firstNameErrorEmi"></span>
																		</div>
																		<div class="half">
																			<label><spring:theme code="text.last.name" /></label>
																			<input type="text" id="lastNameEmi"
																				required="required" maxlength="40"> <span
																				class="error-message" id="lastNameErrorEmi"></span>
																		</div>
																		<div class="full">
																			<label><spring:theme code="text.addressline1" /></label>
																			<input type="text" id="address1Emi" maxlength="40"
																				required="required"> <span
																				class="error-message" id="address1ErrorEmi"></span>
																		</div>
																		<div class="full">
																			<label><spring:theme code="text.addressline2" /></label>
																		...
																		<div class="full">
																			<label><spring:theme code="text.landmark" />
																			</label> <input type="text" id="address3Emi" maxlength="40">
																			<span class="error-message" id="address3ErrorEmi"></span>
																		</div>
																		<div class="full">
																			<label><spring:theme code="text.city" /></label> <input
																				type="text" id="cityEmi" required="required"
																				maxlength="40"> <span class="error-message"
																				id="cityErrorEmi"></span>
																		</div>
																		<div class="half">
																			<label><spring:theme code="text.state" /></label> <input
																				type="text" id="stateEmi" required="required"
																				maxlength="40"> <span class="error-message"
																				id="stateErrorEmi"></span>
																		</div>
																		<div class="half">
																		...
																		<div class="full">
																			...
																			<input type="text" id="pincodeEmi" maxlength="10"
																				onchange="validatePin()"><span
																				class="error-message" id="pinErrorEmi"></span>
																		</div>
																	</fieldset>
																</div>
																<div class="controls remember">
																	<input type="checkbox"
																		class="juspay_locker_save checkbox" id="save-card-emi"
																		name="save-card-emi" /><label for="save-card-emi"><spring:theme
																			code="checkout.multi.paymentMethod.addPaymentDetails.saveCard" /></label>
																</div>
													...
													<p id="emi-notice">
														<spring:theme
															code="checkout.multi.paymentMethod.emi.notice" />
													</p>
													<div class="terms">
														<p class="redirect">You will be redirected to secure
															payment gateway.</p>
														<p onclick="teliumTrack()">
															<spring:theme
																code="checkout.multi.paymentMethod.selectMode.tnc.pretext" />
					...
					<c:if test="${map.value eq true}">
						<c:choose>
							<c:when test="${map.key eq 'COD'}">
								...
								<li class="paymentModeMobile"><span
									id="viewPaymentCODMobile"  onclick="onPaymentModeSelection('COD');"> <spring:theme
				...
				<ycommerce:testId code="paymentDetailsForm">
					...
					<form:form id="silentOrderPostForm" name="silentOrderPostForm"
						class="create_update_payment_form" commandName="paymentForm"
						action="${newPaymentFormMplUrl}" autocomplete="off" method="POST">
							...
							<ul class="product-block net-bank blocks">
								...
								<li class="cod-container cash">
									<div id="otpNUM">
										...
										<input type="hidden" id="cartValue" value="${cartValue}" /> <input
											type="hidden" id="httpRequest" value="${request}" />
									...
									</div> <!-- COD error messages -->
									<div id="codErrorMessage" class="error-message">
										<spring:theme
											code="checkout.multi.paymentMethod.addPaymentDetails.codErrorMessage" />
									</div>

									<div id="codMessage" class="error-message">
										<spring:theme
											code="checkout.multi.paymentMethod.addPaymentDetails.codMessage" />
									</div>


									<div id="customerBlackListMessage" class="error-message">
										<spring:theme
											code="checkout.multi.paymentMethod.addPaymentDetails.customerBlackListMessage" />
									</div>


									<div id="otpValidationMessage" class="error-message">
										<spring:theme
											code="checkout.multi.paymentMethod.addPaymentDetails.otpValidationSuccessfulMessage" />
									</div>


									<div id="wrongOtpValidationMessage" class="error-message">
										<spring:theme
											code="checkout.multi.paymentMethod.addPaymentDetails.wrongOtpValidationMessage" />
									</div> <%-- <div id="otpSentMessage" class="error-message payment-notification"><spring:theme code="checkout.multi.paymentMethod.addPaymentDetails.otpSentMessage"/>
									</div> --%>

									<div id="expiredOtpValidationMessage" class="error-message">
										<spring:theme
											code="checkout.multi.paymentMethod.addPaymentDetails.expiredOtpValidationMessage" />
									</div>

									<div id="fulfillmentMessage"
										class="error-message payment-notification">
										<spring:theme
											code="checkout.multi.paymentMethod.addPaymentDetails.fulfillmentMessage" />
									</div>

									<div id="codItemEligibilityMessage" class="error-message">
										<spring:theme
											code="checkout.multi.paymentMethod.addPaymentDetails.codItemEligibilityMessage" />
									</div>

									<div id="emptyOTPMessage" class="error-message">
										<spring:theme
											code="checkout.multi.paymentMethod.addPaymentDetails.emptyOTPMessage" />
									</div> <!-- COD error messages ends -->
									...
									<div id="submitPaymentFormCODButton">	
										...
										<button type="button"
											class="make_payment button btn-block payment-button confirm"
											id="paymentButtonId" style="display: block;">
											<div id="submitPaymentFormCODButton" style="display: block;">
												<spring:theme
													code="checkout.multi.paymentMethod.codContinue" />
											</div>
										</button>
	...
	<div id="orderDetailsSectionId">
		<single-Checkout:showCheckoutOrderDetails cartData="${cartData}"
		showDeliveryAddress="true" showPaymentInfo="false"
		showTaxEstimate="false" showTax="true" isCart="${isCart}"
		orderData="${orderData}" />
	</div>
</div>
