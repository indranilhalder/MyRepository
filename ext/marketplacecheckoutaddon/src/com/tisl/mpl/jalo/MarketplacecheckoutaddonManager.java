...
/**
 * This is the extension manager of the Marketplacecheckoutaddon extension.
 */
public class MarketplacecheckoutaddonManager extends GeneratedMarketplacecheckoutaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MarketplacecheckoutaddonManager.class.getName());
	 ...
	 */
	public static MarketplacecheckoutaddonManager getInstance()
	{
		return (MarketplacecheckoutaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MarketplacecheckoutaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MarketplacecheckoutaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MarketplacecheckoutaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MarketplacecheckoutaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MarketplacecheckoutaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
