...
/**
 * Provides necessary meta information about the marketplacecheckoutaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.5.1.0
 */
public class MarketplacecheckoutaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(MarketplacecheckoutaddonHMCExtension.class.getName());
