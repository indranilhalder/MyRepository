...
<div  style="color:red" id ="recaptcha_widget_message"></div>
		...
		<div class="control-group clear clearfix">
			...
			<div class="controls">
				cvbcvbcvbcb<input type="text" id="recaptcha_response_field" name="recaptcha_response_field" class="left" style="width:242px;" />
