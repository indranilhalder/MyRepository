...
package marketplacecaptchaaddon;
...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performModifyTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performModifyTypes
				...
				single_createattr_BaseStore_captchaCheckEnabled();
			

	}

	
	public void single_createattr_BaseStore_captchaCheckEnabled() throws JaloBusinessException
	{
	...
	protected final void performCreateObjects( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performCreateObjects
			...
			single_setAttributeProperties_BaseStore_captchaCheckEnabled();
		
	}


		
						public void single_setAttributeProperties_BaseStore_captchaCheckEnabled() throws JaloBusinessException
						{
