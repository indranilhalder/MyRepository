...
/**
 * Provides necessary meta information about the marketplacecaptchaaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.3.0.2
 */
public class MarketplacecaptchaaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(MarketplacecaptchaaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.tisl.mpl.hmc.locales";
