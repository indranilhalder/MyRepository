...
public class SendNotificationEventListener extends AbstractSiteEventListener<SendNotificationEvent>
{
	 ...
	 *
	 */
	private void sendNotification(final ShipmentDTO shipment, final ConsignmentModel consignmentModel,
	...
	private void sendSMSHotc(final List<AbstractOrderEntryModel> childOrders, final String orderNumber, final String mobileNumber,
			...
			final ConsignmentStatus newStatus, final String shortTrackingUrl)
	{
		try
		{
	...
	private void sendEmailHotc(final OrderModel orderModel, final List<AbstractOrderEntryModel> childOrders,
			final String awbNumber, final ConsignmentStatus newStatus, final String shortTrackingUrl)
	{
