 ...
 *  
 */
package com.tisl.mpl.queues.cronjob;

import de.hybris.platform.cronjob.enums.CronJobResult;
import de.hybris.platform.cronjob.enums.CronJobStatus;
import de.hybris.platform.servicelayer.cronjob.AbstractJobPerformable;
import de.hybris.platform.servicelayer.cronjob.PerformResult;
import com.tisl.mpl.model.expressupdate.cron.OrderStatusUpdateCleanerCronJobModel;
import com.tisl.mpl.queues.impl.OrderStatusUpdateQueue;

import java.util.Date;


/**
 * A Cron Job for cleaning up {@link com.tisl.mpl.queues.impl.OrderStatusUpdateQueue}.
 */
