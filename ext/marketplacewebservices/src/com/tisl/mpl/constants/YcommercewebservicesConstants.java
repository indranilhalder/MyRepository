...
public class YcommercewebservicesConstants extends GeneratedYcommercewebservicesConstants
{
	...
	public static final String SEARCHBOXCOMPONENT = "MplEnhancedSearchBox".intern();
	public static final String ATTRIBUTE_NAME = "name".intern();
	...
	public static final String DROPDOWN_BRAND = "brand-";
	public static final String DROPDOWN_CATEGORY = "category-";
	public static final String DROPDOWN_SELLER = "seller-";
