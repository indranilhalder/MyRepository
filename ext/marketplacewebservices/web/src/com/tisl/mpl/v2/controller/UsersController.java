			...
			else
			{
				...
				try
				{
					...
					if (gigyaServiceSwitch != null && !gigyaServiceSwitch.equalsIgnoreCase(MarketplacewebservicesConstants.NO))
					{
						...
						if (null != updateCustomerDetailDto.getFirstName() && null != updateCustomerDetailDto.getLastName())
						{
							gigyaFacade.notifyGigya(updateCustomerDetailDto.getEmailId(), null, updateCustomerDetailDto.getFirstName()
									.trim(), updateCustomerDetailDto.getLastName().trim(), updateCustomerDetailDto.getEmailId().trim(),
									gigyaMethod);
						}
						else
						{
							throw new EtailBusinessExceptions(MarketplacecommerceservicesConstants.B9310);
						}
					}
				}
