		...
		if (contentPage != null)
		{
			...
			try
			{
				...
				if (null != categoryId && !categoryId.isEmpty())
				{
					...
					Boolean toDisplayBrand = Boolean.FALSE;
							...
							.startsWith(configurationService.getConfiguration().getString("marketplace.mplcatalog.salescategory.code")))
					{
						...
						if (null != categoryModels && !categoryModels.isEmpty())
						{
							...
							.startsWith(configurationService.getConfiguration().getString("marketplace.mplcatalog.salesbrand.code")))
					{
						toDisplayBrand = Boolean.TRUE;
					}
					if (toDisplayBrand.booleanValue())
					{
						breadCrumDto.setName("Home");
						breadCrumDto.setUrl(siteUrl);
						breadcrumbs.add(breadCrumDto);
					}
				}
