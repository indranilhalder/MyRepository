...
import com.tisl.mpl.validator.PlaceOrderCartValidator;
...
public class BaseCommerceController extends BaseController
{
	...
	protected CartData setCartDeliveryAddressInternal(final String addressId) throws NoCheckoutCartException
	{
		...
		if (errors.hasErrors())
		{
			throw new CartAddressException("Address given by id " + sanitize(addressId) + " is not valid", CartAddressException.NOT_VALID,
					addressId);
		}
		...
		throw new CartAddressException("Address given by id " + sanitize(addressId) + " cannot be set as delivery address in this cart",
