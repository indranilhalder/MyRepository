...
public class PaymentDetailsDTOValidator implements Validator
{
	...
	public void validate(final Object target, final Errors errors)
	{
		...
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "accountHolderName", MarketplacewebservicesConstants.FIELD_REQD);
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "cardType.code", MarketplacewebservicesConstants.FIELD_REQD);
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "cardNumber", MarketplacewebservicesConstants.FIELD_REQD);
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "expiryMonth", MarketplacewebservicesConstants.FIELD_REQD);
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "expiryYear", MarketplacewebservicesConstants.FIELD_REQD);
