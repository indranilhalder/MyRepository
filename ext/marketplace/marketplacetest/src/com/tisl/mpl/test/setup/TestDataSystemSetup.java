 ...
 *
 */
package com.tisl.mpl.test.setup;
...
import com.tisl.mpl.test.constants.MarketplaceTestConstants;
import com.tisl.mpl.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = MarketplaceTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/marketplacetest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/marketplacetest/import/reviews.impex");
			...
			importImpexFile(context, "/marketplacetest/import/cstickets.impex");
		}
	}
}
