 ...
 *
 */
package com.tisl.mpl.test.orders;
...
public class AcceleratorTestOrderData
{
	...
	private final String EMAIL_ID = "OrderHistoryUser@test.com";
	...
	public void createPaymentInfos()
	{
		...
		createPaymentInfo(EMAIL_ID, USD, createVisaCardInfo(), createUkBillingInfo());
	}
	...
	protected CardInfo createVisaCardInfo()
	{
		...
		cardInfo.setCardHolderFullName(FULL_NAME);
	...
	protected BillingInfo createUkBillingInfo()
	{
		...
		billingInfo.setFirstName(FIRST_NAME);
		billingInfo.setLastName(LAST_NAME);
	...
	public void createSampleOrders()
	{
		// Create sample order in the electronics site
		{
			...
			createSampleOrder("electronics", EMAIL_ID, USD, products, createUkAddressData(), null);
		}
		...
		// Create sample order in the apparel-uk site
		{
			...
			createSampleOrder("apparel-uk", EMAIL_ID, "GBP", products, createUkAddressData(), null);
		}
		...
		// Create sample order in the apparel-de site
		{
			...
			createSampleOrder("apparel-de", EMAIL_ID, "EUR", products, createGermanAddressData(), null);
		}
	}
	...
	public void createSampleBOPiSOrders()
	{
		// Create sample order in the electronics site
		{
			...
			createSampleOrder("electronics", EMAIL_ID, USD, products, createUkAddressData(), "Yokosuka");
		}
		...
		// Create sample order in the apparel-uk site
		{
			...
			createSampleOrder("apparel-uk", EMAIL_ID, "GBP", products, createUkAddressData(), "Newcastle upon Tyne College");
		}
	}
