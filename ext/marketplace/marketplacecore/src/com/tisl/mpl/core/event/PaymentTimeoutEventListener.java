 ...
 *
 */
public class PaymentTimeoutEventListener extends AbstractSiteEventListener<PaymentTimeoutEvent>
{
	@Autowired
	...
	private static final Logger LOG = Logger.getLogger(PaymentTimeoutEventListener.class);
