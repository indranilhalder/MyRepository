 ...
 *
 */
public class DisableMplIndexingCompositeJob extends AbstractJobPerformable<CronJobModel>
{
	private static final Logger LOG = Logger.getLogger(DisableMplIndexingCompositeJob.class);
