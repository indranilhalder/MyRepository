 ...
 *
 */
public class MplRatingCountValuProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider, Serializable
{
			...
			final Object model) throws FieldValueProviderException
	{
		if (model instanceof PcmProductVariantModel)
		{
			...
			{
				final Integer ratingCount = product.getRatingReview().getMplReviewCount();
				...
				if (ratingCount != null)
				{
					...
					{
						//add field values
						fieldValues.addAll(createFieldValue(ratingCount, indexedProperty));
					}
	 ...
	 */
	//Create field values
	protected List<FieldValue> createFieldValue(final int ratingCount, final IndexedProperty indexedProperty)
	{
		...
		{
			//Add field values
			fieldValues.add(new FieldValue(fieldName, ratingCount));
		}
		return fieldValues;
	}
