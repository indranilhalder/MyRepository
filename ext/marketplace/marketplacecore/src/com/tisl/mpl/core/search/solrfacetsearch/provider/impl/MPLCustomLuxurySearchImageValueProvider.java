 ...
 *
 */
public class MPLCustomLuxurySearchImageValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider,
		Serializable
{

	private static final Logger LOG = Logger.getLogger(MPLCustomLuxurySearchImageValueProvider.class);
