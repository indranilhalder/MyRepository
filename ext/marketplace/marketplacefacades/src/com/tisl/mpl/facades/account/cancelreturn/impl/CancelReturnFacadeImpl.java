...
public class CancelReturnFacadeImpl implements CancelReturnFacade
{
	...
	public CODSelfShipResponseData codPaymentInfoToFICO(CODSelfShipData codSelfShipData)
	{
		...
		if(StringUtils.isNotEmpty(codSelfShipData.getAmount())){
			requestData.setAmount(codSelfShipData.getAmount());
		}else{
			requestData.setAmount("00");
		}
		if(StringUtils.isNotEmpty(codSelfShipData.getBankAccount())){
			requestData.setBankAccount(codSelfShipData.getBankAccount());
		}else{
			requestData.setBankAccount("NA");
		}
		if(StringUtils.isNotEmpty(codSelfShipData.getBankKey())){
			requestData.setBankKey(codSelfShipData.getBankKey());
		}else{
			requestData.setBankKey("NA");
		}
		if(StringUtils.isNotEmpty(codSelfShipData.getTransactionID())){
			requestData.setTransactionID(codSelfShipData.getTransactionID());
		}else{
			requestData.setTransactionID("NA");
		}
		if(StringUtils.isNotEmpty(codSelfShipData.getOrderDate())){
			requestData.setOrderDate(codSelfShipData.getOrderDate());
		}else{
			requestData.setOrderDate("NA");
		}
		if(StringUtils.isNotEmpty(codSelfShipData.getTransactionDate())){
			requestData.setTransactionDate(codSelfShipData.getTransactionDate());
		}else{
			requestData.setTransactionDate("NA");
		}
		if(StringUtils.isNotEmpty(codSelfShipData.getTitle())){
			requestData.setTitle(codSelfShipData.getTitle().toUpperCase());
		}else{
			requestData.setTitle("NA");
		}
		if(StringUtils.isNotEmpty(codSelfShipData.getPaymentMode())){
			requestData.setPaymentMode(codSelfShipData.getPaymentMode());
		}else{
			requestData.setPaymentMode("NA");
		}
		if(StringUtils.isNotEmpty(codSelfShipData.getBankName())){
			requestData.setBankName(codSelfShipData.getBankName());
		}else{
			requestData.setBankName("NA");
		}
		if(StringUtils.isNotEmpty(codSelfShipData.getName())){
			requestData.setName(codSelfShipData.getName());
		}else{
			requestData.setName("NA");
		}
		if(StringUtils.isNotEmpty(codSelfShipData.getOrderTag())){
			requestData.setOrderTag(codSelfShipData.getOrderTag());
		}else{
			requestData.setOrderTag("NA");
		}
		if(StringUtils.isNotEmpty(codSelfShipData.getOrderNo())){
			requestData.setOrderNo(codSelfShipData.getOrderNo());
		}else{
			requestData.setOrderNo("NA");
		}
		if(StringUtils.isNotEmpty(codSelfShipData.getCustomerNumber())){
			requestData.setCustomerNumber(codSelfShipData.getCustomerNumber());
		}else{
			requestData.setCustomerNumber("NA");
		}
		if(StringUtils.isNotEmpty(codSelfShipData.getOrderRefNo())){
			requestData.setOrderRefNo(codSelfShipData.getOrderRefNo());
		}else{
			requestData.setOrderRefNo("NA");
		}
		if(StringUtils.isNotEmpty(codSelfShipData.getTransactionType())){
			requestData.setTransactionType(codSelfShipData.getTransactionType());
		}else{
			requestData.setTransactionType("NA");
		}
