 ...
 *
 */
public class TakeActionOnHeldOrderEmailContext extends AbstractEmailContext<NotifyPaymentGroupProcessModel>
{

	private static final String JUSPAYORDERID = "juspayOrderId";
	private static final String TAT = "tatRemaining";
	...
	public void init(final NotifyPaymentGroupProcessModel notifyPaymentGroupProcessModel, final EmailPageModel emailPageModel)
	{
		...
		if (null != notifyPaymentGroupProcessModel.getTatRemaining())
		{
			put(TAT, notifyPaymentGroupProcessModel.getTatRemaining());
		}
