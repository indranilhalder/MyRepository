...
public class OrderNotificationEmailContext extends AbstractEmailContext<OrderProcessModel>
{
	...
	private static final String SUBTOTALFORJEWELLERY = "subTotalForJewellery";  //jewellery
	...
	public void init(final OrderProcessModel orderProcessModel, final EmailPageModel emailPageModel)
	{
		...
		double totalFineJewelleryPrice = 0.0d;    //added for fine jewellery
		...
		put(SUBTOTALFORJEWELLERY, Double.valueOf(totalFineJewelleryPrice));   //added forjewellery
