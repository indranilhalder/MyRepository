...
public interface MplStoreLocatorFacade
{
	 ...
	 */
	public ProudctWithPointOfServicesData populateProductWithStoresForUssid(final String ussid,
			final Model model, final Map<String, Long> freebieProductsWithQuant, 
			final List<PointOfServiceModel> posModelList, final SellerInformationModel sellerInfoModel);
	/**
	 * 
	 * @param posModel
	 * @param ussId
