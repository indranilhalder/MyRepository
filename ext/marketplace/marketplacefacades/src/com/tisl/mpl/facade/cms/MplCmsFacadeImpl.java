...
public class MplCmsFacadeImpl implements MplCmsFacade
{
	 ...
	 */
	/*
	 * public Converter<AmpServiceworkerModel, AmpServiceWorkerData> getAmpServiceworkerConverter() { return
	 * ampServiceworkerConverter; }
	 *//**
	 * @param ampServiceworkerConverter
	 *           the ampServiceworkerConverter to set
	 */
	/*
	 * public void setAmpServiceworkerConverter(final Converter<AmpServiceworkerModel, AmpServiceWorkerData>
	 * ampServiceworkerConverter) { this.ampServiceworkerConverter = ampServiceworkerConverter; }
	 *//**
	 * @return the ampMenifestJsonConverter
	 */
	/*
	 * public Converter<AmpMenifestModel, AmpMenifestData> getAmpMenifestJsonConverter() { return
	 * ampMenifestJsonConverter; }
	 *//**
	 * @param ampMenifestJsonConverter
	 *           the ampMenifestJsonConverter to set
	 */
	/*
	 * public void setAmpMenifestJsonConverter(final Converter<AmpMenifestModel, AmpMenifestData>
	 * ampMenifestJsonConverter) { this.ampMenifestJsonConverter = ampMenifestJsonConverter; }
	 *//**
