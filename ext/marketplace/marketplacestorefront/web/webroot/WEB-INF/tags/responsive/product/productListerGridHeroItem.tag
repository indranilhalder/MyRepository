			...
			<div class="image">
				...
				<c:if test="${!product.isOnlineExclusive && product.isOfferExisting}">
					<div style="z-index: 2;" class="on-sale">
						<img class="brush-strokes-sprite sprite-Vector_Smart_Object"
							src="${pageContext.request.scheme}://${staticHost}/_ui/responsive/common/images/transparent.png"> <span>On Offer</span>
					</div>
				</c:if>
				...
				<c:if test="${product.isOnlineExclusive}">
					<div style="z-index: 1;" class="online-exclusive">
						<img class="brush-strokes-sprite sprite-Vector_Smart_Object"
							src="${pageContext.request.scheme}://${staticHost}/_ui/responsive/common/images/transparent.png"> <span>online
							exclusive</span>
					</div>
				</c:if>
