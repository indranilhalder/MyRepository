	...
	function hit(options) {
		...
		if (opts.windowWidth < 1025) {
			...
			setTimeout(function() {
				...
				$("#zoomModal .imageList ul li img").css("height",
						...
						if ($(window).width() > 789) {
							$(".picZoomer-pic-wp img")
									.attr(
											'data-zoom-image',
											$(
													".product-image-container .productImageGallery .imageList .active img")
													.attr("data-zoomimagesrc"));
...
<div class="main-image span-14 productImage">
	...
	<div style="z-index: 1; display: none" class="online-exclusive">
		<img class="brush-strokes-sprite sprite-Vector_Smart_Object"
			src="//${mplStaticResourceHost}/_ui/responsive/common/images/transparent.png">
...
<div class="modal fade" id="videoModal" tabindex="-1" role="dialog"
	...
	<div class="modal-content content"
		...
		<button type="button" class="close pull-right"
			onclick="closingVideo()" aria-hidden="true" data-dismiss="modal"
			style="width: 15px; height: 15px; top: 0; right: 0px;">
			<!-- TISPRO-508 -->
		</button>
		<iframe name="videoFrame" id="player" width="100%" height="100%"
