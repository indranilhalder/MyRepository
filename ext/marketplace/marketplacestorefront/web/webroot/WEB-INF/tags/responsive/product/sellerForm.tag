<input type="hidden" maxlength="10" size="1" id="sellersSkuListId"
					...
					<input type="hidden" maxlength="10" size="1" id="skuIdForHD"
						...
						<input type="hidden" maxlength="10" size="1" id="selectedSizeVariant"
						name="selectedSizeVariant" value="" />	
							<input type="hidden" maxlength="10" size="1" id="stockDataArray" name="stockDataArray" value="" />
				<input type="hidden" maxlength="10" size="1" id="isPinCodeChecked" name="isPinCodeChecked" value="" />		
