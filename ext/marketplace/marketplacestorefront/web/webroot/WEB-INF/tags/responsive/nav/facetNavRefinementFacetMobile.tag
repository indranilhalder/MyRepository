					...
					<c:choose>
						...
						<li class="filter-${facetData.code}">	  
							  <form action="${url}" method="get"> 
								...
								<input type="hidden" name="facetValue" value="${facetValue.code}"/>
								<label>
								<input type="checkbox" ${facetValue.selected ? 'checked="checked"' : ''}  class="facet-checkbox js-facet-checkbox sr-only js-facet-sizebutton" value="${facetValue.code}"/>	<!-- extra class added for SDI-4484 -->	
								<span class="facet-label">
										<span class="facet-mark"></span>
										<div class="facet-text">
										<span class="facet-text">
