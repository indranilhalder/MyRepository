	...
	<li class="item">
		...
		<ul class="mobile-product">
			...
			<li class="shipping">
				...
				<ul class="${entry.mplDeliveryMode.name}">
					<li class="deliver-type">${entry.mplDeliveryMode.name}
						&nbsp;&nbsp;</li>
					...
					<c:choose>
						<c:when
							...
							<li class="deliver">Your Order Will Be Delivered on
								${entry.selectedDeliverySlotDate} - ${entry.timeSlotFrom} TO
								${entry.timeSlotTo}</li>

						</c:when>
						<c:otherwise>
							<li class="deliver">Your Order Will Be Delivered
								${entry.eddDateBetWeen}</li>
