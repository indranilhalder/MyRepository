...
<%-- 	<script type="text/javascript" src="${themeResourcePath}/combined/luxury-main.js?v=${buildNumber}"></script> --%>
	...
	<c:if test="${isIAEnabled}">
		<script type="text/javascript" src="${commonResourcePath}/js/minified/ia.min.js?v=${buildNumber}"></script>	<script type="text/javascript" src="${themeResourcePath}/js/lib/jquery.lazy.min.js"></script>
	</c:if>
		<script type="text/javascript" src="${themeResourcePath}/js/lib/jquery.lazy.min.js"></script>
