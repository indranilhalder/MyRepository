...
<div class="pdp">
	...
	<c:set var="clothing"><spring:theme code='product.footware'/></c:set>  <!-- Added for TISPRO-271 -->
	<!-- For Infinite Analytics Start -->
	<input type="hidden" value="${productCategoryType}" id="categoryType"/>
<c:choose>
		<c:when test="${productCategoryType==clothing || productCategoryType==footware}">  <!-- Added for TISPRO-271 -->
