...
<div class="removeModalAfterLoad" id="changeAddressPopup">
	<div class="modal-dialog changeAdddd">
		...
		<form:form action="${request.contextPath}/my-account/returns/editReturnAddress" method="POST"
								 commandName="addressForm" name="addressForm" class="form-horizontal" id="addAddressForm">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 NOP">
							...
							<input type="hidden" id="temp"/>
								<h4 class="editAddress"><spring:theme code="text.order.returns.editshippingaddress"/></h4>
								...
								<div class="col-md-6 form-group">
									<label for="lastName"><spring:theme code="text.order.returns.lastname"/></label> <form:input path="lastName"
							...
							<div class="row">
								<div class="col-md-12 form-group">
									<label for="addressLine2"><spring:theme code="text.order.returns.addressline2"/></label> <form:input path="line2" class="form-control textInputChangeAddress"
                          ...
                          <spring:theme code="text.order.returns.landmarkother"/></label>
							...
							<div class="row">
								...
								<div class="col-md-6 form-group">
									<label for="country">
									<spring:theme code="text.order.returns.country"/></label> <input 
										class="form-control textInputChangeAddress textDisabled" id="country" value="India"
