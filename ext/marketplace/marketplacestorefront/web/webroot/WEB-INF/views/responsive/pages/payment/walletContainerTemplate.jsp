...
<!-- 					<span class="addMoreGiftVouchersBtn"><input type="button" class="addMoreBtn" value="+ ADD MORE" /></span> -->
					<div class="col-sm-6 addGiftVoucherSub">
						...
						<form:input path="cardNumber" maxlength="16" type="text" placeholder="Enter 16 digit card number"  onkeypress="return isNumberKey(event)"  class="giftVoucherNo" />
					</div>
					<div class="col-sm-6 addGiftVoucherSub">
					    ...
					    <form:input path="cardPin" class="giftVoucherPin" maxlength="6" type="password" onkeypress="return isNumberKey(event)" placeholder="Enter 6 digit pin number" />
					</div>
				</div>&nbsp;
				<hr class="dividerVS" />
			</div>
