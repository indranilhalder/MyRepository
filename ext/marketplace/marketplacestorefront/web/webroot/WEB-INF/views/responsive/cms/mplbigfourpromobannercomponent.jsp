...
<c:if test="${not empty component}">
	...
	<c:choose>
		<c:when test="${not empty component.urlLink}">
			<a class="homebanner_${component.sequenceNumber}" href="${bannerUrl}"><div class="homebanner_${component.sequenceNumber} hero icid fourPromoBanner">
					<div class="image">
		...
		<c:otherwise>
			<div class="homebanner_${component.sequenceNumber} hero icid fourPromoBanner">
				<div class="image">
					<img src="${component.bannerImage.URL}" alt="">
				</div>
				<ul class="major-promos">
