						...
						<div class="custmCareForms">
							...
							<div class="formGroup">
								<div class="selectOrderSec">
									...
									<div class="selectOrders">
										<div class="selectedProduct">Select order from your
											previous orders</div>
										<ul class="orderDrop">
								...
								<select class="node formControl customSelect" name="nodeL2">
									...
									<c:forEach items="${formFields.nodes}" var="l2Node">
										<c:if test="${l2Node.nodeType eq 'L2'}">
											<option value="${l2Node.nodeCode}"
												nodeText="${l2Node.nodeDesc}"
												displayAllow="${l2Node.nodeDisplayAllowed}">${l2Node.nodeDesc}</option>
										</c:if>
									</c:forEach>
								</select>
							</div>
									...
									<c:forEach items="${formFields.nodes}" var="l3Node">
										<c:if test="${l3Node.nodeType eq 'L3'}">
											<option value="${l3Node.nodeCode}"
												nodeText="${l3Node.nodeDesc}"
												displayAllow="${l3Node.nodeDisplayAllowed}">${l3Node.nodeDesc}</option>
										</c:if>
									</c:forEach>
								</select>
							</div>
							...
							<div id=form_details>
								...
								<div class="formGroup">
									...
									<textarea id="textarea" rows="8" cols="66" maxlength="1000"
