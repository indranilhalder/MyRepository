			...
			<cms:pageSlot position="DefaultNewUIContentSlot" var="feature">
				...
				<c:forEach items="${feature.items}" var="smartfilterElements">
						 ...
						 <div class="col-xs-6 pad0 mb16">
									<a href=#">
									<img src="${smartfilterElements.imageURL.URL}" class="img-responsive" />
						...
						<div class="auto-brand-product-slider">
							<c:forEach items="${feature.items}"
								...
								<c:if
									...
									<div>
										<a href="${automatedBrandProductCarElement.webURL}"> <img
											src="https://via.placeholder.com/148x192" />
											...
											<c:if test="${not empty automatedBrandProductCarElement.productCode}">
														<fmt:parseNumber var = "productPrice" type = "number" value = "${bannerProdCarouselElement.productCode.mrp}" />
													<div class="product-price">${productPrice}
													</div>
													</c:if>
								...
								<div>
									<c:if
										...
										<div class="col-xs-12 pad0 mb40 landing-page-header-component"
											style="background-image:url(${landingPageHeaderElement.imageURL.URL}),linear-gradient(to bottom, #000000, #000000);">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#search-for-brand').keyup(function(e) {
		    ...
		    input = document.getElementById("search-for-brand");
		    filter = input.value.toUpperCase();
		    ul = document.getElementById("brandslist-leftsection");
		...
		$('#brandinitials-section li a').click(function(e) {
			...
			if( $(brandinitial).length > 0){
				...
				document.getElementById('brandslist-leftsection').scrollTop = brandinitial_offset;
			}
			$('#brandinitials-section li a').removeClass('active-brandinitial');
