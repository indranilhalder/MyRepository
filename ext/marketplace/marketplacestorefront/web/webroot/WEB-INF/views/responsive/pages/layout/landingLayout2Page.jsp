...
<%-- <jsp:include page="/WEB-INF/views/responsive/fragments/home/atozBrandPanel.jsp"/> --%>
<%-- <div class="atozhtml" id="atozhtmlsrc" >
<%@include file="/WEB-INF/views/responsive/fragments/home/atozBrandPanel.jsp"%>
</div> --%>
