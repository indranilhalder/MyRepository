...
<div class="toggle ${fn:replace(component.masterBrandName,' ', '')}">
	<c:url var="masterBrandUrl" value="${component.masterBrandURL}" />
	<a class="${fn:replace(component.masterBrandName,' ', '')}" href="${masterBrandUrl}">${component.masterBrandName}</a>
</div>
				...
				<div class="" style="width: 50%; float: right">
					<div>
						...
						<c:if test="${(not empty subBrand.subBrandImage) && (count<1)}">
							<img width="200" height="300" src="${subBrand.subBrandImage.URL}" />
							<br>
							<c:url var="subBrandUrl" value="${subBrand.subBrandUrl}"></c:url>
							<a
