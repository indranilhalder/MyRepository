...
review_quality:g,review_ease_of_use:e,review_fit:h,review_value_for_money:f,user_product_rating:d,Seller_rating:" "});getRating($("input[name=gigya_api_key]").val(),$("input[name=gigya_product_code]").val(),$("input[name=gigya_product_root_category]").val())}function reviewClick(a){CheckUserLogedIn()}
...
" REVIEWS"),$("#ratingDiv .gig-rating-readReviewsLink").text(a.streamInfo.ratingCount+" REVIEWS"));$("#customer").text("Customer Reviews ("+a.streamInfo.ratingCount+")");utag.link({product_rating:g})}gigya.comments.showRatingUI({categoryID:c,streamID:b,containerID:"ratingDiv",linkedCommentsUI:"commentsDiv",showCommentButton:"true",onAddReviewClicked:function(a){a=getCookie("mpl-user");"session"==getCookie("mpl-userType")&&"anonymous"==a&&gotoLogin()}})});void 0!=typeof $("#loginDiv").html()&&gigya.socialize.showLoginUI({height:100,
width:330,showTermsLink:!1,hideGigyaLink:!0,buttonsStyle:"signInWith",containerID:"loginDiv",cid:"",enabledProviders:"facebook,google"});void 0!=typeof $("#loginDivReg").html()&&gigya.socialize.showLoginUI({height:100,width:330,showTermsLink:!1,hideGigyaLink:!0,buttonsStyle:"signInWith",containerID:"loginDivReg",cid:"",enabledProviders:"facebook,google"});void 0!=typeof $("#loginDivCheckout").html()&&gigya.socialize.showLoginUI({height:100,width:330,showTermsLink:!1,hideGigyaLink:!0,buttonsStyle:"signInWith",
containerID:"loginDivCheckout",cid:"",enabledProviders:"facebook,google"});void 0!=typeof $("#loginDivsiginflyout").html()&&gigya.socialize.showLoginUI({height:100,width:330,showTermsLink:!1,hideGigyaLink:!0,buttonsStyle:"signInWith",containerID:"loginDivsiginflyout",cid:"",enabledProviders:"facebook,google"})}function getPdpRatingOnSizeSelect(a,b,c){getRating(a,b,c)}
