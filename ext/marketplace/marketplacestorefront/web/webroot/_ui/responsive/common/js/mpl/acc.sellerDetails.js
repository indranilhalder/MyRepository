...
/*	
	...
	function fetchSellers(sellersArray,buyboxSeller)
	{
	 ...
	 function addToBag(index){
        ...
        if(!$("#variant li ").hasClass("selected") && typeof($(".variantFormLabel").html())== 'undefined' && $("#ia_product_rootCategory_type").val()!='Electronics'&& $("#ia_product_rootCategory_type").val()!='Watches' && $("#ia_product_rootCategory_type").val()!='Accessories' && $("#ia_product_rootCategory_type").val()!='FineJewellery' && $("#showSize").val()=='true'){
		...
		//TPR-887 //INC144313255
		 ...
		 //$(document).on('click','#addToCartFormId'+index+' #buyNowButton'+index,function(){
	        if(!$("#variant li ").hasClass("selected") && typeof($(".variantFormLabel").html())== 'undefined' && $("#ia_product_rootCategory_type").val()!='Electronics' && $("#ia_product_rootCategory_type").val()!='Accessories' && $("#ia_product_rootCategory_type").val()!='Watches'&& $("#ia_product_rootCategory_type").val()!='FineJewellery'){
