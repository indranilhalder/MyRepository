	function checkReturnSelected() {
		...
		function changeRadioColor(type){
			if(type == "replace"){
				...
				$(".scheduledPickupArea .address1 input, .scheduledPickup #scheduleReturnTime1").prop("checked", true);
		...
		function showPickupTimeDate(classId) {
			...
			$("#hiddenFields #landmark").val($(".update"+classId+" li span.addressline2").text());
		  ...
		  if(addressType == "newAddress") {
			 ...
			 // alert(count);
			  ...
			  if(checkPopupValidations()) {
				  $(".scheduledPickupArea").append("<div class='address"+count+" col-md-12 col-sm-12 col-xs-12 greyColor selectScheduledPickup'><div class='col-md-2 col-sm-2 col-xs-2 selectRadio'><input class=radioButton name=selectScheduledPickup onclick='showPickupTimeDate(\"address"+count+"\")' type='radio' value='schedule'></div><div class='col-md-6 col-sm-6 col-xs-6 updateaddress"+count+"'><ul><li><span class=firstName>Balagangadhar</span> <span class=lastName>Ganga</span><li><span class=addressline1>Plot no 500 AyyaappaSocity</span><li><span class=addressline2>Madhapur</span><li><span class=addressTown>Hyderabad</span><li><span class=state>Telangana</span><li><span class=postalCode>500041</span><li><span class=country>India</span><li><span class=phoneNumber>2583691409</span><li id=addressUniqueId style=display:none>8796781182999</ul></div><div class='col-md-4 col-sm-4 col-xs-4 editAddress'><a class=changeAddressLink onclick='showAddressPopup(\"address"+count+"\")' data-class=address"+count+" href=#>Edit Address</a></div></div>");
