...
function validateForm() {
    ...
    var a = document.getElementById("dateOfBirth").selectedIndex,
        ...
        n = document.getElementById("dateOfAnniversary").value,
        p = document.getElementById("monthOfAnniversary").value,
        t = document.getElementById("yearOfAnniversary").value,
        z = k + "/" + f + "/" + g,
        u = n + "/" + p + "/" + t,
        r = new Date(f + "/" + k + "/" + g),
        q = new Date(p + "/" + n + "/" + t),
    ...
    if (0 < a || 0 < b || 0 < d) isNaN(k) || isNaN(f) || isNaN(g) ? ($("#errdobDay").css({
        display: "block",
        "margin-top": "10px"
    }), document.getElementById("errdobDay").innerHTML = "<font color='red' size='2'>Please Enter Valid Date </font>", e = !1) : v > x ? ($("#errdobDay").css({
            display: "block",
            "margin-top": "10px"
        }), document.getElementById("errdobDay").innerHTML = "<font color='red' size='2'>Date of Birth cannot be Future Date</font>",
        e = !1) : c.test(z) ? c.test(z) && (document.getElementById("errdobDay").innerHTML = "<font display='none' size='2'></font>") : ($("#errdobDay").css({
        display: "block",
        "margin-top": "10px"
    }), document.getElementById("errdobDay").innerHTML = "<font color='red' size='2'>Please Enter Valid Date </font>", e = !1);
    if (0 < h || 0 < l || 0 < m) isNaN(n) || isNaN(p) || isNaN(t) ? ($("#errdoaDay").css({
            display: "block",
            "margin-top": "10px"
        }), document.getElementById("errdoaDay").innerHTML = "<font color='red' size='2'>Please Enter Valid Date </font>",
        e = !1) : q > y ? (document.getElementById("errdoaDay").innerHTML = "<font color='red' size='2'>Date of Anniversary cannot be Future Date</font>", e = !1) : w > x ? ($("#errdoaDay").css({
        display: "block",
        "margin-top": "10px"
    }), document.getElementById("errdoaDay").innerHTML = "<font color='red' size='2'>Date of Anniversary cannot be Future Date</font>", e = !1) : c.test(u) ? c.test(u) && (z == u ? ($("#errdata").css({
            display: "block",
            "margin-top": "10px"
...
function validateAccountAddress() {
    ...
    null == addressForm.mobileNo.value || "" == addressForm.mobileNo.value ? ($("#errddressMob").css({
        display: "block"
    }), document.getElementById("erraddressMob").innerHTML = "<font color='red' size='2'>Please enter mobile number</font>", n = !1) : 10 < addressForm.mobileNo.value.length || 10 > addressForm.mobileNo.value.length || isNaN(addressForm.mobileNo.value) ? ($("#errddressMob").css({
            display: "block"
        ...
        n = !1) : c.test(addressForm.mobileNo.value) && ($("#errddressMob").css({
        display: "block"
    }), document.getElementById("erraddressMob").innerHTML = "<font color='red' size='2'>Mobile number should contain 10 digit numbers only</font>", n = !1);
    return d && e && k && f && g && h && l && m && n ? !0 : !1
}
...
ACC.carousel = {
    _autoload: ["myFun", "shopByLookCarousel", "categoryCarousel", "myStyleCarousel", "heroProductCarousel", "springflingCarousel", "advancedCategoryCarousel", ["bindCarousel", 0 < $(".js-owl-carousel").length]],
    carouselConfig: {
        "default": {
            navigation: !0,
            rewindNav: !1,
        ...
        $.widget("custom.yautocomplete", $.ui.autocomplete, {
            ...
            source: function(a, b) {
                ...
                $.getJSON(c.options.autocompleteUrl, {
                    ...
                    var g = [];
                    null != a.brands && (void 0 != a.brands[0] && g.push({
                    ...
                    null != a.categories && (void 0 != a.categories[0] && g.push({
...
function validateEnteredName(a, b) {
    var c = $("#" + a).val();
    /^[ _a-zA-Z0-9_ ]*[ _a-zA-Z0-9_ ]+[ _a-zA-Z_ ]*$/i.test(c) || (c = c.substring(0, c.length - 1), $("#" + b).html("<font color='#ff1c47'><b>*</b>Special charecters are not allowed</font>"), $("#" + b).show().fadeOut(3E3));
    $("#" + a).val(c)
};
ACC.nowtrending = {
...
function openPop(a) {
    ...
    $.ajax({
        ...
        error: function(a, b, e) {
            $("#wishListNonLoggedInId").show(); << << << < HEAD
...
function loadDefaultWishListName() {
    ...
    $("#wishListNonLoggedInId").hide();
    $("#wishListDetailsId").show();
    a = a + "<tr><td><input type='text' id='defaultWishName' onkeyup='return onKeyUpWishlistNameValidate();' value='" + b + "'/></td></td></tr>";
    $("#wishlistTbodyId").html(a)
}

function onKeyUpWishlistNameValidate() {
    var a = !1,
        b = $("#defaultWishName").val(),
        a = /^[ _a-zA-Z0-9_ ]*[ _a-zA-Z0-9_ ]+[ _a-zA-Z_ ]*$/i.test(b);
    "" == b || a ? a = !0 : (b = b.substring(0, b.length - 1), $("#defaultWishName").val(b), $("#addedMessage").show(), $("#addedMessage").html("<font color='#ff1c47'><b>Special charecters are not allowed</b></font>"), $("#addedMessage").show().fadeOut(3E3));
    return a
}
...
var wishListList = []; >>> >>> > BRANCH_TCS - HYCOMM - R2SPRINT - 68 _19 - 02 - 2016 _21 - 32 - 31
...
function addToWishlist() {
    var a = $("#productCodePost").val(),
        b = "",
        b = "" == wishListList ? $("#defaultWishName").val() : wishListList[$("#hidWishlist").val()];
    if ("" == b) return a = $("#wishlistnotblank").text(), $("#addedMessage").show(), $("#addedMessage").html(a), !1;
    ...
    $.ajax({
        contentType: "application/json; charset=utf-8",
        url: c,
        data: "wish=" + b + "&product=" + a + "&ussid=" +
            ussidValue + "&sizeSelected=" + d,
        dataType: "json",
        success: function(a) {
...
function refreshSellers(a, b) {
    for (var c = [], d = $("#isproductPage").val(), e = [], k = [], f = -1, g = -1, h = -1, l = 0, m = [], n = [], p = [], t = [], z = -1, u = -1, r = 0; r < a.length; r++)
        if (b != a[r].ussid)
            if ("Y" == a[r].isServicable) {
                "Y" == a[r].cod && (p[++u] = "'" + a[r].ussid + "'");
                e[r] = "'" + a[r].ussid + "'";
                l += 1;
                0 == a[r].stockCount && (k[++f] = "'" + a[r].ussid + "'");
                var q = a[r].validDeliveryModes,
                    v;
                for (v in q) {
                    var w = q[v].type;
                    "HD" == w && (n[++h] = "'" + a[r].ussid + "'");
                    ...
                    w = {};
                    w.ussid = a[r].ussid;
                    w.stock = a[r].stockCount;
                    t[++z] =
                        w;
                    $("#stockDataArray").val(JSON.stringify(t))
                }
            } else c[++g] = a[r].ussid;
    ...
    $("#sellerListId").html("");
    "false" == d && ($("#sellerTable").show(), $("#other-sellers-id").show(), 0 < l ? fetchAllSellers(t) :
...
$(function() {
    ...
    $(".submit").click(function() {
        ...
        var b = !1,
            c = $("#ussid").val(),
            d = $("#pin").val(),
            e = ACC.config.encodedContextPath + "/p/checkPincode";
        if ("" == d) return $("#unsevisablePin,#unableprocessPin,#wrongPin").hide(),
            $("#emptyPin").show(), !1;
            ...
            success: function(a) {
                ...
                for (var e in a) {
                    ...
                    if (ussid == c)
                        if ("Y" == d.isServicable) {
                            b = !0;
                            deliveryModes = d.validDeliveryModes;
                            var h = !1,
                                l = !1,
                                m = !1;
                            0 == d.stockCount ? ($("#addToCartButton").hide(), $("#outOfStockId").show(), $("#stock").val(0)) : $("#addToCartButton").show();
                            "Y" == d.cod && $("#codId").show();
                            for (var p in deliveryModes) deliveryModeName = deliveryModes[p].type, $("#stock").val(d.stockCount), "HD" == deliveryModeName ? h = !0 : "CNC" == deliveryModeName ? m = !0 : l = !0;
...
function openPop_SizeGuide() {
    ...
    $.ajax({
        contentType: "application/json; charset=utf-8",
        url: ACC.config.encodedContextPath + "/p/viewWishlistsInPDP",
        data: "productCode=${product.code}&ussid=" + ussidValue,
        dataType: "json",
        success: function(a) {
            null == a ? ($("#wishListNonLoggedInId_sizeGuide").show(), $("#wishListDetailsId_sizeGuide").hide()) : "" == a || a == [] ? loadDefaultWishListName_SizeGuide() : LoadWishLists_SizeGuide(ussidValue,
                a, "${product.code}")
        },
        error: function(a, b, c) {
...
function addToWishlist_SizeGuide() {
    var a = "",
        a = "" == wishListList ? $("#defaultWishName_sizeGuide").val() : wishListList[$("#hidWishlist_sizeGuide").val()];
    if ("" == a) {
        var b = $("#wishlistnotblank_sizeGuide").text();
        $("#addedMessage_sizeGuide").show();
        $("#addedMessage_sizeGuide").html(b);
        return !1
    }
    if (void 0 == a || null == a) return !1;
    var b = ACC.config.encodedContextPath + "/p/addToWishListInPDP",
        c = !0;
    "#" == $("#variant.size-g option:selected").val() && (c = !1);
    $.ajax({
        contentType: "application/json; charset=utf-8",
        url: b,
        data: "wish=" +
            a + "&product=${product.code}&ussid=" + ussidValue + "&sizeSelected=" + c,
        dataType: "json",
        success: function(b) {
            if (1 == b && ($("#radio_" + $("#hidWishlist_sizeGuide").val()).prop("disabled", !0), b = $("#wishlistSuccess_sizeGuide").text(), $("#addedMessage_sizeGuide").show(), $("#addedMessage_sizeGuide").html(b), setTimeout(function() {
                    $("#addedMessage_sizeGuide").fadeOut().empty()
                }, 1500), populateMyWishlistFlyOut(a), b = $("input[name=isMSDEnabled]").val(), "true" === b)) {
                console.log(b);
                var c = $("input[name=isApparelExist]").val();
                console.log(c);
                var k = $("input[name=salesHierarchyCategoryMSD]").val();
                console.log(k);
                var f = $("input[name=rootCategoryMSD]").val();
                console.log(f);
                var g = $("input[name=productCodeMSD]").val();
                console.log(g);
                var h = $("input[id=price-for-mad]").val();
                console.log(h);
                "undefined" === typeof b && (b = !1);
                "undefined" === typeof c && (c = !1);
                Boolean(b) && Boolean(c) && "Clothing" === f && ACC.track.trackAddToWishListForMAD(g, k, h, "INR")
            }
        }
    });
    setTimeout(function() {
...
if ("undefined" != typeof arrayrating) {
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", "button.updateReviewConfirmation", function() {
            var a = $(this).parents("li.review-li").attr("data-index");
            $(".errorUpdateReview" + a).empty();
            $(".errorUpdateRating" + a).empty();
            var b = $("input[name=updateReviewHeading" + a + "]").val(),
                c = $("textarea[name=updateReviewComment" + a + "]").val(),
                d = $(".categoryID" + a).val(),
                e = $(".streamID" + a).val(),
                k = $(".commentID" + a).val();
            if ("" != d && "" != e && "" != k) {
                var f = $("ul[data-rating-name" + a + "=overall] li span.full").length,
                    g = $("ul[data-rating-name" + a + "=fit] li span.full").length,
                    h = $("ul[data-rating-name" + a + "=value_for_money] li span.full").length,
                    l = $("ul[data-rating-name" + a + "=quality] li span.full").length,
                    m = $("ul[data-rating-name" + a + "=easeOfUse] li span.full").length,
                    n = null,
                    p = null;
                "Electronics" == d ? (n = "{'_overall':" + f + ", 'Quality':" + l + ",'Ease of use':" + m + ",'Value for Money':" + h + "}", p = {
                    overall: f,
                    easeOfUse: m,
                    value_for_money: h,
                    quality: l
                }) : "Clothing" == d || "Footwear" == d ? (n = "{'_overall':" + f + ", 'Quality':" + l + ",'Fit':" + g + ",'Value for Money':" + h + "}", p = {
                    overall: f,
                    fit: g,
                    value_for_money: h,
                    quality: l
                }) : n = "{'_overall':" + f + ", 'Quality':" + l + ",'Fit':" + g + ",'Value for Money':" + h + "}";
                $.ajax({
                    url: "review/edit",
                    type: "POST",
                    dataType: "JSON",
                        ...
                        if (e)
                            if ("success" == e.status) {
                                if (void 0 != a) {
                                    ...
                                    $(k).hide();
                                    g = e = null;
                                    "Electronics" == d ? (e = p.easeOfUse, e = e / 5 * 100) : (g = p.fit, g = g / 5 * 100);
                                    h = p.quality;
                                    h = h / 5 * 100;
                                    k = p.value_for_money;
                                    k = k / 5 * 100;
                                    $("ul.rating-stars[data-rating-name" + a + "=_overall] li span").remove();
                                    $("ul.rating-stars[data-rating-name" + a + "=_overall] li").append("<span></span>");
                                    for (var l = 0; l < f; l++) $("ul.rating-stars[data-rating-name" +
                                        a + "=_overall] li span").eq(l).addClass("full");
                                    null == e ? $("div[data-rating" + a + "=fit]").attr("style", "width:" + g + "%") : $("div[data-rating" + a + "=easeOfUse]").attr("style", "width:" + e + "%");
                                    $("div[data-rating" + a + "=value]").attr("style", "width:" + k + "%");
                                    $("div[data-rating" + a + "=quality]").attr("style", "width:" + h + "%");
                                    $("div[data-info-id=" + a + "]").show()
                                }
                            } else "failed" == e.status && $("div[data-danger-id=" + a + "]").show()
                    },
                    fail: function() {
                        globalErrorPopup("Please try after some time.")
                    },
...
function fetchSellers(a, b) {
    ...
    var l = -1,
        ...
        t = 0,
        z = 0;
    "false" == d && (sellerskuidList = $("#sellersSkuListId").val(), ussidIdsForED = $("#skuIdForED").val(), ussidIdsForHD = $("#skuIdForHD").val(), ussidIdsForCOD = $("#skuIdForCod").val(), stockUssidIds = $("#skuIdsWithNoStock").val(), stockUssidArray = $("#stockDataArray").val());
    for (d =
        0; d < a.length; d++)
        if (b != a[d].ussid) {
            var u = 0;
            ...
            if (-1 == sellerskuidList.indexOf(a[d].ussid)) {
                ...
                var f = f + ("<tr id='tr" + m + "Id'>"),
                    ...
                    h = a[d].ussid,
                    r = "<div id='addToCartFormId" + m + "Title' name='addToCartFormId" + m + "Title' class='addToCartTitle'>" + $("#addtocartid").text() + "</div><div id='addToCartFormId" + m + "Title' class='addToCartTitle sellerAddToBagTitle'>" + $("#addtocartid").text() + "</div><form method='post'  name='addToCartFormId" +
                    m + "' id='addToCartFormId" + m + "' class='add_to_cart_form' action='#'>",
                    f = f + "<td width='278px'><h3>",
                    f = f + a[d].sellername,
                    f = f + "</h3></td>",
                    f = f + "<td width='153px'>";
                null != a[d].spPrice && "" != a[d].spPrice && 0 != a[d].spPrice.value ? (n = a[d].spPrice, p = a[d].mrpPrice, t = n.value, z = p.value) : null != a[d].mopPrice && "" != a[d].mopPrice.value ? (n = a[d].mopPrice, p = a[d].mrpPrice, t = n.value, z = p.value) : (n = a[d].mrpPrice, t = n.value);
                skuPriceMap = {};
                skuPriceMap.key = a[d].ussid;
                skuPriceMap.value = t;
                skuPriceArray[++l] = skuPriceMap;
                f += "<div class='price price-line-height'>";
                0 < z && z != t && (f += "<del>", f += p.formattedValue, f += "</del>", f += " ");
                f += "<font color=#ff1c47>";
                f += n.formattedValue;
                f += "</font>";
                f += "</div>";
                ...
                parseFloat(t) > emiCuttOffAmount.value && (f += "<div class='emi'>", f +=
                    $("#emiavailableid").text(), f += "</div>");
                var f = f + "</td>",
                    q = a[d].deliveryModes,
                    n = "",
                    v = !1,
                    t = !1,
                    w;
                for (w in q) - 1 != q[w].code.toLowerCase().indexOf("home") && (v = !0), -1 != q[w].code.toLowerCase().indexOf("express") && (t = !0), n += q[w].code + "-" + q[w].deliveryCost.formattedValue;
                q = "";
                if ("true" != $("#isPinCodeChecked").val()) {
                    if (v) var v = parseInt($("#homeStartId").val()) + u,
                        y = parseInt($("#homeEndId").val()) + u,
                        v = e + v + "-" + y + k,
                        x = availableDeliveryATPForHD.concat("-").concat(v),
                        q = q + (x + "<br/>");
                    t && (q += availableDeliveryATPForED +
                        "<br/>")
                } else -1 != ussidIdsForED.indexOf(h) && (v = parseInt($("#expressStartId").val()) + u, y = parseInt($("#expressEndId").val()) + u, v = e + v + "-" + y + k, q += availableDeliveryATPForED + "<br/>"), -1 != ussidIdsForHD.indexOf(h) && (v = parseInt($("#homeStartId").val()) + u, y = parseInt($("#homeEndId").val()) + u, v = e + v + "-" + y + k, "" != x && (x = availableDeliveryATPForHD.concat("-").concat(v)), q += x + "<br/>");
                f += "<td width='669px'><ul>";
                f += "<li>";
                f += q;
                f += "</li>";
                "true" == $("#isPinCodeChecked").val() ? -1 != ussidIdsForCOD.indexOf(h) && (f += "<li>" +
                    $("#cashondeliveryid").text() + "</li>") : "Y" == a[d].isCod && (f += "<li>" + $("#cashondeliveryid").text() + "</li>");
                f += "<li>";
                f += a[d].replacement + $("#replacementguranteeid").text();
                f += "</li>";
                f += "<li><span class='tooltip_wrapper'><a>" + $("#deliveryratesid").text() + "</a><span class='tooltip_pop'>" + n + "</span></span> & ";
                ...
                f += "<input type='hidden' size='1' id='stock' name='stock' value=" + g + ">";
                f += "<input type='hidden' size='1' id='ussid' name='ussid' value=" + h + ">";
                "true" != $("#isPinCodeChecked").val() ? 0 >= g || null == a[d].deliveryModes ? $("#addToCartButton" + m).hide() : (f += "<div id='addToCartFormId" + m + "excedeInventory' style='display:none;'>" + $("#addToCartFormexcedeInventory").text() +
                    ...
                    m + "noInventory' style='display:none;'>" + $("#addToCartFormnoInventory").text() + "</div>", f += "<button id='addToCartButton" + m + "' type='button' class='button add-to-bag btn-block js-add-to-cart'>" + $("#addtobagid").text() + "</button>", f += $("#hiddenIdForStock").html());
                f += "</form>";
                f += "<form id='wish'>";
...
$(document).ready(function() {
    ...
    var b = null;
    $("body").hasClass("page-multiStepCheckoutSummaryPage") || $("body").hasClass("page-checkout-login") || (0 == $(window).scrollTop() &&
        ...
        k = function(b) {
            ...
            d = setTimeout(function() {
                for (var b = 0, c = e.length; b < c; b++) {
                    ...
                    if (k !== d.matches) {
                        d.matches = k;
                        for (var k = 0, p = f.length; k < p; k++) f[k].call(window, d)
                    }
                }
            }, 30)
        };
...
function getBrandsYouLoveContentAjaxCall(a) {
    window.localStorage && (html = window.localStorage.getItem("brandContent-" + a)) && "" != html ? ($(".home-brands-you-love-carousel").css("margin-bottom", "20px"), $(".home-brands-you-love-desc").remove(), $("#brandsYouLove").append(decodeURI(html))) : $.ajax({
                ...
                success: function(b) {
                    ...
                    "undefined" !== typeof b.firstProductImageUrl && (defaultHtml += "<div class='home-brands-you-love-side-image left'><a href='" + ACC.config.encodedContextPath + b.firstProductUrl + "'><img src='" + b.firstProductImageUrl + "'></img>", "undefined" !== typeof b.firstProductTitle && (defaultHtml += "<p class='product-name'>" + b.firstProductTitle +
                        "</p>"), "undefined" !== typeof b.firstProductPrice && (defaultHtml += "<p class='price normal'><span class='priceFormat'>" + b.firstProductPrice + "</span></p>"), defaultHtml += "</a></div>");
                    ...
                    "undefined" !== typeof b.bannerImageUrl && (defaultHtml += "<div class='home-brands-you-love-main-image-wrapper'>", "undefined" !== typeof b.bannerText && (defaultHtml += "<div class='visit-store-wrapper'>" + b.bannerText + "</div>"), === === =
                        url: ACC.config.encodedContextPath + "/getBrandsYouLoveContent", data: {
                            id: a
                        }, success: function(b) {
                            $(".home-brands-you-love-desc").remove();
                            defaultHtml = "<div class='home-brands-you-love-desc'>";
                            ...
                            defaultHtml += "<div class='home-brands-you-love-main-image'>";
                            "undefined" !== typeof b.bannerImageUrl && (defaultHtml += "<div class='home-brands-you-love-main-image-wrapper'>", "undefined" !== typeof b.bannerText && (defaultHtml += "<div class='visit-store-wrapper'>" + b.bannerText + "</div>"), >>> >>> > BRANCH_TCS - HYCOMM - R2SPRINT - 68 _19 - 02 - 2016 _21 - 32 - 31 defaultHtml += "<img src='" + b.bannerImageUrl + "'></img></div></div>");
            ...
            var bulCount = $(".home-brands-you-love-carousel-brands.active").index() - 1; $(document).on("click", ".home-brands-you-love-carousel-brands", function() {
            ...
            }); $("#ia_site_page_id").val(); 0 == $("#bestPicks").children().length && "homepage" == $("#ia_site_page_id").val() && getBestPicksAjaxCall();
