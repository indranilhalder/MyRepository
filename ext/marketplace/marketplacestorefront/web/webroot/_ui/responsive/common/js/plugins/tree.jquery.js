...
ElementsRenderer = (function() {
  ...
  ElementsRenderer.prototype.createNodeLi = function(node) {	  
    ...
    div.appendChild(title_span);
    //----------------------------------------------------------------//
    facetCount_span = document.createElement('span');
    facetCount_span.className = "jqtree-facetCount jqtree_common";
    facetCount_span.innerHTML = node.facetCount; 
    div.appendChild(facetCount_span);
    //---------------------------------------------------------------//    
    return li;
  };
