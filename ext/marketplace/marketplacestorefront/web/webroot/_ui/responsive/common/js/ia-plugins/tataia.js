			  ...
			  /* IA Changes Start for store/mpl/en */
				  ...
				  if(obj.discounted_price != null || obj.discounted_price != '' || obj.discounted_price != "undefined" ){
					  ...
					  if(obj.original_price != null && parseInt(obj.original_price) > parseInt(obj.discounted_price) ){
						  ...
						  html += '<p class="old mrprice">â‚¹'+parseInt(obj.original_price)+'</p>';

					  }

					  else if(obj.price != null && parseInt(obj.price) > parseInt(obj.discounted_price) && parseInt(obj.price) > 0){

						  html += '<p class="old moprice">â‚¹'+parseInt(obj.price)+'</p>';

					  }

					  //TISPRO-317 changes

					  html += '<p class="sale discprice">â‚¹'+parseInt(obj.discounted_price)+'</p>';
					  ...
					  html += '<p class="normal moprice">â‚¹'+parseInt(obj.price)+'</p>';
					  ...
					  html += '<p class="sale moprice">â‚¹'+parseInt(obj.price)+'</p>';
			  ...
			  if(jQuery.inArray(widgetMode, productWidget) > -1) {
			    ...
			    if(slider) {
			      ...
			      if(site_page_type === "homepage" || site_page_type ==="viewAllTrending") {
			        ...
			        html += '<li><input type="checkbox" id="0-500"> <label for="0-500">â‚¹0 - â‚¹500</label></li><li><input type="checkbox" id="500-1000"> <label for="500-1000">â‚¹500 - â‚¹1000</label></li><li><input type="checkbox" id="1000-2000"> <label for="1000-2000">â‚¹1000 - â‚¹2000</label></li><li><input type="checkbox" id="2000-3000"> <label for="2000-3000">â‚¹2000 - â‚¹3000</label></li><li><input type="checkbox" id="3000-4000"> <label for="3000-4000">â‚¹3000 - â‚¹4000</label></li><li><input type="checkbox" id="4000-5000"> <label for="4000-5000">â‚¹4000 - â‚¹5000</label></li>';

			        html += '<li><input type="checkbox" id="5000-10000"> <label for="5000-10000">â‚¹5000 - â‚¹10000</label></li><li><input type="checkbox" id="10000-25000"> <label for="10000-25000">â‚¹10000 - â‚¹25000</label></li><li><input type="checkbox" id="25000-50000"> <label for="25000-50000">â‚¹25000 - â‚¹50000</label></li><li><input type="checkbox" id="And>50000"> <label for="And>50000">â‚¹50000 And Above</label></li>';
