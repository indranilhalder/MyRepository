        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $.each(response.subItems, function(k, v) {
                    ...
                    if (v.imageUrl) {
                        renderHtml +=
                            "<div class='home-best-pick-carousel-img'> <img src='" +
                            v.imageUrl + "'></img></div>";
                    }
                    if (v.text) {
                        renderHtml +=
                ...
                renderHtml +=
                    "</div> <a href='/store/o/viewAllOffers' class='view-cliq-offers'> View Cliq Offers </a>";
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $.each(response.categories, function(k, v) {
                    ...
                    //for image
                    renderHtml +=
                        "<div class='home-product-you-care-carousel-img'> <img src='" +
                        v.mediaURL + "'></img></div>";
                    renderHtml +=
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            renderHtml =
                ...
                '</a></div><div class="qued-image"><img src="' +
