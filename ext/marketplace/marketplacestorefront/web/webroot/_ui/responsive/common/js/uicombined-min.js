...
}(jQuery), window.TATA || (window.TATA = {});
...
TATA.CommonFunctions = {
    ...
    Header: {
        ...
        init: function() {
            this.MobileMenu(), this.SigninPopup();
        }
    },
    Footer: function() {
    ...
    init: function() {
        ...
        _self.ShopByCatagorySlider(), _self.addTowishlist(), _self.leftBarAccordian();
    }
}, TATA.Pages = {
    PLP: {
        Filtershow: function() {
