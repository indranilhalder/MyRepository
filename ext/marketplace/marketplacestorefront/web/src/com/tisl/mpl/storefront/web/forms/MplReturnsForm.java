...
/**
 * @param reEnterAccountNumber the reEnterAccountNumber to set
 */
...
/**
 * @param scheduleReturnDate the scheduleReturnDate to set
 */
...
/**
 * @param scheduleReturnTime the scheduleReturnTime to set
 */
public void setScheduleReturnTime(String scheduleReturnTime)
{
...
/**
 * @param isCODorder the isCODorder to set
 */
public void setIsCODorder(String isCODorder)
{
...
public String toString()
{
	return "MplReturnsForm [returnReason=" + returnReason + ", refundType=" + refundType + ", accountNumber=" + accountNumber
			...
			+ returnMethod + ", firstName=" + firstName + ", storeIds=" + Arrays.toString(storeIds) + ", addressType=" + addressType
			+ ", lastName=" + lastName + ", addrLine1=" + addrLine1 + ", addrLine2=" + addrLine2 + ", addrLine3=" + addrLine3
			+ ", landMark=" + landMark + ", pincode=" + pincode + ", phoneNumber=" + phoneNumber + ", city=" + city + ", state="
			+ state + ", country=" + country + ", isDefault=" + isDefault + ", scheduleReturnDate=" + scheduleReturnDate
			+ ", scheduleReturnTime=" + scheduleReturnTime + ", isCODorder=" + isCODorder + ", orderCode=" + orderCode
			+ ", transactionId=" + transactionId + ", ussid=" + ussid + "]";
}
