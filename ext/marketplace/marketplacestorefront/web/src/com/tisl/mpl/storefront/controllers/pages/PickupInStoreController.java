...
public class PickupInStoreController extends AbstractSearchPageController
{
	...
	public String getPointOfServiceForStorePickupSubmit(@PathVariable("productCode") final String productCode,
			...
			@RequestParam(value = ModelAttributetConstants.ENTRY_NO, defaultValue = "0") final Long entryNumber,
	...
	public String getPointOfServiceForStorePickupClick(@PathVariable("productCode") final String productCode,
			...
			@RequestParam(value = "show", defaultValue = "Page") final AbstractSearchPageController.ShowMode showMode,
			@RequestParam(value = "sort", required = false) final String sortCode,
			@RequestParam(value = "cartPage") final Boolean cartPage,
			@RequestParam(value = ModelAttributetConstants.ENTRY_NO) final Long entryNumber, final HttpServletResponse response,
			final Model model)
	{
			...
			final Long entryNumber, final Model model, final RequestMethod requestMethod, final HttpServletResponse response)
	{
		...
		model.addAttribute(ModelAttributetConstants.ENTRY_NO, entryNumber);
		...
		try
		{
			...
			else if (cartModification.getQuantityAdded() < qty)
			{
				model.addAttribute(ERROR_MSG_TYPE,
						ModelAttributetConstants.QTY_REDUCED_NO_ITEMS_ADDED + cartModification.getStatusCode());
			}
	...
	public String updateCartQuantities(@RequestParam("storeNamePost") final String storeId,
			@RequestParam(ModelAttributetConstants.ENTRY_NO) final long entryNumber,
			@RequestParam("hiddenPickupQty") final long quantity, final RedirectAttributes redirectModel)
					throws CommerceCartModificationException
	{
		...
		else if (!CommerceCartModificationStatus.SUCCESS.equals(cartModificationData.getStatusCode()))
		{
			...
			GlobalMessages.addFlashMessage(redirectModel, GlobalMessages.ERROR_MESSAGES_HOLDER,
					ModelAttributetConstants.QTY_REDUCED_NO_ITEMS_ADDED + cartModificationData.getStatusCode());
		}
	...
	public String updateToDelivery(@RequestParam(ModelAttributetConstants.ENTRY_NO) final long entryNumber,
