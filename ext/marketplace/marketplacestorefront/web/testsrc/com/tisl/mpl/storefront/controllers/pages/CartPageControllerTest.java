...
public class CartPageControllerTest
{
	...
	private static final String SHOW_CHECKOUT_STRATEGY_OPTIONS = "storefront.show.checkout.flows";
	...
	{
		BDDMockito.given(service.getProperty(SHOW_CHECKOUT_STRATEGY_OPTIONS)).willReturn(null);
	...
	{
		BDDMockito.given(service.getProperty(SHOW_CHECKOUT_STRATEGY_OPTIONS)).willReturn("someString");
	...
	{
		BDDMockito.given(service.getBoolean(SHOW_CHECKOUT_STRATEGY_OPTIONS, false)).willReturn(Boolean.TRUE);
	...
	{
		BDDMockito.given(service.getProperty(SHOW_CHECKOUT_STRATEGY_OPTIONS)).willReturn("0");
	...
	{
		BDDMockito.given(service.getProperty(SHOW_CHECKOUT_STRATEGY_OPTIONS)).willReturn("");
