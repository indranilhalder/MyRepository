	...
	protected HtmlBasedComponent createContentInternal(
		...
		if(CollectionUtils.isNotEmpty(discounts))
		{
			...
			for(DiscountModel discount:discounts){	
				...
				{
					final PriceData couponVal=discountUtility.createPrice(cartModel, ((PromotionVoucherModel)discount).getValue());
				...
				{
					final PriceData couponMaxVal=discountUtility.createPrice(cartModel, ((PromotionVoucherModel)discount).getMaxDiscountValue());
