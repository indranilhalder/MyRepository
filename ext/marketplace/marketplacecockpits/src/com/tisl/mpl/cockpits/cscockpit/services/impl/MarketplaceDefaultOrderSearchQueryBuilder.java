...
public class MarketplaceDefaultOrderSearchQueryBuilder extends
	...
	public static enum OrderStatuses {
		Empty, AWB_ASSIGNED, CANCELLATION_INITIATED, CLOSED_ON_CANCELLATION, CLOSED_ON_RETURN_TO_ORIGIN, CNC_INITIATED,COD_CLOSED_WITHOUT_REFUND, DELIVERED, HOTC, INVOICE_GENERATED, LOGISTIC_PARTNER_SWITCH, LOST_IN_TRANSIT, MANIFESTO_PENDING, ORDER_ACCEPTED, ORDER_ALLOCATED, ORDER_CANCELLED, ORDER_COLLECTED,ORDER_REJECTED, OUT_FOR_DELIVERY, PACKED, PAYMENT_SUCCESSFUL, PENDING_SELLER_ASSIGNMENT, PICK_CONFIRMED, PICK_HOLD, PICK_IN_PROGRESS, PICK_LIST_GENERATED, PRINT_INVOICE, PRINT_SHIPPING_LABEL, QC_FAILED,READY_FOR_COLLECTION, REDISPATCH_INITIATED, REACHED_NEAREST_HUB, READY_TO_SHIP, REFUND_IN_PROGRESS, REFUND_INITIATED, RETURN_CANCELLED, RETURN_CLOSED, RETURN_COMPLETED, RETURN_INITIATED,RETURNINITIATED_BY_RTO, RETURN_RECEIVED, RETURN_REJECTED, RETURN_TO_ORIGIN, REVERSE_AWB_ASSIGNED, RMS_VERIFICATION_FAILED, RMS_VERIFICATION_PENDING, UNDELIVERED
