...
public interface MarketPlaceOrderManagementActionsWidgetController extends OrderManagementActionsWidgetController{
	public abstract boolean isChangeDeliveryAddressPossible(TypedObject orderObject);
