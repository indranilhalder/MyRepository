 ...
 *
 */
package com.tisl.mpl.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("marketplacecockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("marketplacecockpits.product.externalTaxes"));
