...
public class MarketplaceServiceabilityCheckHelperImpl implements MarketplaceServiceabilityCheckHelper {
					...
					if (null != deliveryModeResponse.getDeliveryMode())
					{
						...
						for (final DeliveryModeResOMSWsDto deliveryMode : deliveryModeResponse.getDeliveryMode())
						{
								...
								if (deliveryMode.getIsCOD().equalsIgnoreCase(MarketplaceCockpitsConstants.YES))
								{
									...
									data.setIsCODLimitFailed((MarketplaceCockpitsConstants.YES).equals(deliveryMode.getIsCODLimitFailed())?true:false);
									data.setIsCOD((MarketplaceCockpitsConstants.YES).equals(deliveryMode.getIsCOD())?true:false);
									data.setIsPincodeServiceable((MarketplaceCockpitsConstants.YES).equals(deliveryMode.getIsPincodeServiceable())?true:false);
									data.setIsPrepaidEligible(deliveryMode.getIsPrepaidEligible().equals(MarketplaceCockpitsConstants.YES)?true:false);
	...
	public List<SellerInformationData> getSellerInformation(final
