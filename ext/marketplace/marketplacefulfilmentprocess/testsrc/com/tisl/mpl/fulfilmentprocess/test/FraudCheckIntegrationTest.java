...
public class FraudCheckIntegrationTest extends ServicelayerTest
{
	...
	/**
	 * Load bean definition from marketplacefulfilmentprocess-spring-test-fraudcheck.xml
	 */
	@BeforeClass
	...
	protected static final String PARAM_NAME_MIN_PERIOD_WAITING_FOR_CLEANUP_IN_SECONDS = "marketplacefulfilmentprocess.fraud.minPeriodWaitingForCleanUpInSeconds";
	protected static final String PARAM_NAME_FRAUD_SCORE_LIMIT = "marketplacefulfilmentprocess.fraud.scoreLimit";
	protected static final String PARAM_NAME_FRAUD_SCORE_TOLERANCE = "marketplacefulfilmentprocess.fraud.scoreTolerance";
	...
	public void before() throws Exception
	{
		...
		{
			importCsv("/marketplacefulfilmentprocess/test/testTicketEssentialData.csv", "utf-8");
		}
		importCsv("/marketplacefulfilmentprocess/test/testWarehouses.csv", "utf-8");
	...
	protected String submitOrderMock(final OrderModel order)
	{
		final OrderProcessModel businessProcessModel = (OrderProcessModel) businessProcessService.createProcess(
				MarketplaceFulfilmentProcessConstants.ORDER_PROCESS_NAME + order.getCode() + +System.currentTimeMillis(),
				MarketplaceFulfilmentProcessConstants.ORDER_PROCESS_NAME);
