 ...
 *
 */
package com.tisl.mpl.fulfilmentprocess.test.jobs;
...
import com.tisl.mpl.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = MarketplaceFulfilmentProcessConstants.ORDER_PROCESS_NAME;
