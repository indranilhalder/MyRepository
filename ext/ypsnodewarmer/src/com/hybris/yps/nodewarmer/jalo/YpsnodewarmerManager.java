...
/**
 * This is the extension manager of the Ypsnodewarmer extension.
 */
public class YpsnodewarmerManager extends GeneratedYpsnodewarmerManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(YpsnodewarmerManager.class.getName());
	 ...
	 */
	public static YpsnodewarmerManager getInstance()
	{
		return (YpsnodewarmerManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				YpsnodewarmerConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public YpsnodewarmerManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of YpsnodewarmerManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of YpsnodewarmerManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of YpsnodewarmerManager called, current tenant: " + getTenant().getTenantID());
		}
	}
