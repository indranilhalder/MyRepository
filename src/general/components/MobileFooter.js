    ...
    return (
      <div className={styles.base}>
        <MobileFooterItem
          ...
          value="home"
          text="Home"
          selected={this.props.selected === "home" ? true : false}
        />
        <MobileFooterItem
          ...
          value="categories"
          text="Categories"
          selected={this.props.selected === "categories" ? true : false}
        />
        <MobileFooterItem
          ...
          value="brands"
          text="Brands"
          selected={this.props.selected === "brands" ? true : false}
        />
        <MobileFooterItem
          ...
          value="profile"
          text="My Cliq"
          selected={this.props.selected === "profile" ? true : false}
        />
        <MobileFooterItem
          ...
          value="bag"
          text="My Bag"
          selected={this.props.selected === "bag" ? true : false}
        />
      </div>
    );
  }
