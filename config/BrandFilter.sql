      ...
      --B.OWNERPKSTRING
            ...
            ( SELECT distinct
            			c3.p_code L1,
									...
									c1.p_code L3,
									b1.p_code BrandCode, 
									REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(LOWER(cname2.p_name||'-'||cname1.p_name||'-'||cname.p_name||'-'||bname.p_name||'/c-'||c1.p_code||'/b-'||b1.p_code),' ', '-'),'''',''),'!',''),'&',''),',',''),'~',''),'`',''),'@',''),'@',''),'$',''),'%',''),'^',''),'*',''),'(',''),')',''),'_',''),'+',''),'=',''),'[',''),']',''),':',''),'<',''),'>','')  "URL3", 
									REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(LOWER(cname2.p_name||'-'||cname1.p_name||'-'||bname.p_name||'/c-'||c2.p_code||'/b-'||b1.p_code),' ','-'),'''',''),'!',''),'&',''),',',''),'~',''),'`',''),'@',''),'@',''),'$',''),'%',''),'^',''),'*',''),'(',''),')',''),'_',''),'+',''),'=',''),'[',''),']',''),':',''),'<',''),'>','') "URL2",
									REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(LOWER(cname2.p_name||'-'||bname.p_name||'/c-'||c3.p_code||'/b-'||b1.p_code),' ','-'),'''',''),'!',''),'&',''),',',''),'~',''),'`',''),'@',''),'@',''),'$',''),'%',''),'^',''),'*',''),'(',''),')',''),'_',''),'+',''),'=',''),'[',''),']',''),':',''),'<',''),'>','')  "URL1"
                  --'0',
                  --'0'
                  --'0'
